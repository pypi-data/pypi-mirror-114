...
#The key in neomodel's _NODE_CLASS_REGISTRY will be a list contains the class name and all inherited classes
NODE_TYPES = [inherited_labels(eval(nodename)) for nodename in NODE_TYPES]
...
class Neo4jDatabase(BaseGraphDatabase):
    ...
    def __init__(self, host, username, password):
        ...
        self.node_classes = {item[0]: db._NODE_CLASS_REGISTRY[frozenset(item)]
