...
class FilesApi(object):
    ...
    def get_owned_fileinfos(self, **kwargs):  # noqa: E501
        ...
        :param bool group_by_parents: Will group the children together by their common top level file. 
        :param bool include_descendants: Will return each top level file with a list of ALL of its descendants 
        :param bool all_keys: Will return all file values if True, otherwise just the date, type, and hash 
    ...
    def get_owned_fileinfos_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['_date', 'start_date', 'end_date', 'public', 'only_top_level', 'page', 'limit', 'file_type', 'children_file_type', 'group_by_parents', 'include_descendants', 'all_keys']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
