    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_developer_tools_notifications._jsii": [
            "cdk-developer-tools-notifications@1.39.0.jsii.tgz"
        ],
        "cloudcomponents.cdk_developer_tools_notifications": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-codestarnotifications>=1.116.0, <2.0.0",
        "aws-cdk.aws-iam>=1.116.0, <2.0.0",
        "aws-cdk.aws-lambda-event-sources>=1.116.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.116.0, <2.0.0",
        "aws-cdk.aws-sns>=1.116.0, <2.0.0",
        "aws-cdk.core>=1.116.0, <2.0.0",
        "cloudcomponents.cdk-chatops>=1.39.0, <2.0.0",
