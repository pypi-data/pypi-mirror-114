...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '3.1.0-alpha.1627287699+8b0f4b14'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 3.1.0-alpha.1627287699+8b0f4b14`
                """)
            else:
                raise
