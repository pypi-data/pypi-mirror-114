...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '3.1.0-alpha.1627469496+d3121e58'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 3.1.0-alpha.1627469496+d3121e58`
                """)
            else:
                raise
