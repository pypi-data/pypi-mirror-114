...
setup(
  name = 'ExtractCard',         # How you named your package folder (MyLib)
  packages = ['ExtractCard'],   # Chose the same as "name"
  package_data={'ExtractCard': ['text/*.txt', 'checkpoints/CTPN.pth']},
