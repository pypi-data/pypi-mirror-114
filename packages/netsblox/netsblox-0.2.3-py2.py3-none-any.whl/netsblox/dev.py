...
class AirQuality:
    ...
    def quality_index(self, latitude: float, longitude: float) -> float:
        ...
        return float(res)
    def quality_index_by_zip_code(self, zip_code: float) -> float:
        '''
...
class Alexa:
    ...
    def create_skill(self, configuration: dict) -> str:
        ...
        :configuration: 
          ...
          - :intents: (list) Intents (ie, commands) supported by the skill.
          - :description: (str) 
          - :category: (Any) 
          - :keywords: (List[str]) 
          - :summary: (str) 
...
class Battleship:
    ...
    def place_ship(self, ship: str, row: float, column: float, facing: str) -> bool:
        ...
        return bool(res)
    def remaining_ships(self, role_id: str) -> float:
        '''
    ...
    def reset(self) -> bool:
        ...
        return bool(res)
    def ship_length(self, ship: str) -> float:
        '''
...
class Chart:
    ...
    def draw(self, lines: list, options: Optional[dict] = None) -> Any:
        ...
        :options: Configuration for graph title, axes, and more
          ...
          - :types: (list) types for each line
...
class ConnectN:
    ...
    def play(self, row: float, column: float):
        '''
...
class Eclipse2017:
    ...
    def select_section_based(self, num_sections: float, per_section: float):
        '''
...
class GoogleMaps:
    ...
    def get_longitude_from_x(self, x: float) -> float:
        ...
        return float(res)
    def get_map(self, latitude: float, longitude: float, width: float, height: float, zoom: float) -> Any:
        '''
    ...
    def get_satellite_map(self, latitude: float, longitude: float, width: float, height: float, zoom: float) -> Any:
        '''
    ...
    def get_terrain_map(self, latitude: float, longitude: float, width: float, height: float, zoom: float) -> Any:
        '''
...
class Hangman:
    ...
    def get_currently_known_word(self) -> str:
        ...
        return str(res)
    def get_wrong_count(self) -> float:
        '''
...
class HumanMortalityDatabase:
    ...
    def get_time_series(self, country: str, gender: Optional[str] = None, category: Optional[Any] = None) -> list:
        '''
...
class NewYorkTimes:
    ...
    def get_best_seller_lists(self) -> List[str]:
        ...
        return vectorize(str)(res)
    def get_best_sellers(self, list: Any, date: Optional[str] = None) -> list:
        '''
    ...
    def get_latest_articles(self, section: Any) -> List[str]:
        '''
        ...
        return vectorize(str)(res)
    def get_most_emailed_articles(self, period: Any) -> list:
        '''
    ...
    def get_most_shared_articles(self, period: Any) -> list:
        '''
    ...
    def get_most_viewed_articles(self, period: Any) -> list:
        '''
    ...
    def get_top_stories(self, section: Any) -> List[str]:
        '''
...
class PhoneIoT:
    ...
    def __init__(self, client):
        self._client = client
    def add_button(self, device: Any, x: Any, y: Any, width: Any, height: Any, text: Optional[str] = None, options: Optional[dict] = None) -> str:
        '''
        ...
        :options: Additional options
          ...
          - :event: (str) The name of a message type to be sent each time the button is pressed. You must call PhoneIoT.listenToGUI to actually receive these messages. If not specified, no event is set. Message fields: id.
          - :style: (Any) The display style of the button on the screen. This can be rectangle (default), ellipse, square, or circle. If square or circle is used, the height of the control is ignored (height equals width).
          - :color: (Any) The background color of the button.
          - :text_color: (Any) The text color of the button.
          - :landscape: (bool) If set to true, rotates the button 90 degrees around its top left corner.
          - :font_size: (Any) The size of the font to use for text (default 1.0).
        ...
        return str(res)
    def add_image_display(self, device: Any, x: Any, y: Any, width: Any, height: Any, options: Optional[dict] = None) -> str:
        '''
        ...
        :options: Additional options
          - :id: (str) The id to use for the control. If not specified, a new one will be automatically generated.
          - :event: (str) The name of a message type to be sent each time the user updates the content (only possible if readonly = false). You must call PhoneIoT.listenToGUI to actually receive these messages. If not specified, no event is set. Message fields: id.
          ...
          - :fit: (Any) The technique used to fit the image into the display, in case the image and the display have different aspect ratios. This can be fit (default), zoom, or stretch.
        
        :returns: id of the created control
        '''
        res = self._client._call('PhoneIoT', 'addImageDisplay', { 'device': device, 'x': x, 'y': y, 'width': width, 'height': height, 'options': options })
        return str(res)
    def add_joystick(self, device: Any, x: Any, y: Any, width: Any, options: Optional[dict] = None) -> str:
        '''
        ...
        return str(res)
    def add_label(self, device: Any, x: Any, y: Any, text: Optional[str] = None, options: Optional[dict] = None) -> str:
        '''
        ...
        :options: Additional options
          - :id: (str) The id to use for the control. If not specified, a new one will be automatically generated.
          - :text_color: (Any) The text color of the label.
          - :align: (Any) The text alignment to use. If set to left, the text starts at the label position. If set to right, the text ends at the label position. If set to center, the text is centered on the label position.
          - :font_size: (Any) The size of the font to use for text (default 1.0).
        ...
        return str(res)
    def add_radio_button(self, device: Any, x: Any, y: Any, text: Optional[str] = None, options: Optional[dict] = None) -> str:
        '''
        ...
        :options: Additional options
          ...
          - :id: (str) The id to use for the control. If not specified, a new one will be automatically generated.
          - :event: (str) The name of an event to send every time the user clicks the radio button. Note that clicking a radio button always checks it, unlike toggles. You must call PhoneIoT.listenToGUI to actually receive these messages. If not specified, no event is set. Message fields: id, state.
          ...
          - :color: (Any) The color of the radio button itself.
          - :text_color: (Any) The text color of the radio button.
          - :font_size: (Any) The size of the font to use for text (default 1.0). Note that this will also scale up the size of the radio button itself (not just the text).
        ...
        return str(res)
    def add_slider(self, device: Any, x: Any, y: Any, width: Any, options: Optional[dict] = None) -> str:
        '''
        ...
        :options: Additional options
          - :id: (str) The id to use for the control. If not specified, a new one will be automatically generated.
          - :event: (str) The name of a message type to be sent each time the user touches, slides, or lets go of the slider. The messages also include a tag field which functions identically to the one in PhoneIoT.addTouchpad. You must call PhoneIoT.listenToGUI to actually receive these messages. If not specified, no event is set. Message fields: id, level, tag.
          - :color: (Any) The color of the slider.
          - :value: (float) The initial value of the slider (default 0.0).
          - :style: (Any) Controls the appearance of the slider. Allowed values are slider (default) or progress.
        ...
        return str(res)
    def add_text_field(self, device: Any, x: Any, y: Any, width: Any, height: Any, options: Optional[dict] = None) -> str:
        '''
        ...
        :options: Additional options
          - :id: (str) The id to use for the control. If not specified, a new one will be automatically generated.
          - :event: (str) The name of an event to send every time the user changes the text content (only possible if readonly = false). Note that this event is only sent once the user clicks accept on the new content (you do not get an event for every key press). You must call PhoneIoT.listenToGUI to actually receive these messages. If not specified, no event is set. Message fields: id, text.
          - :text: (str) This can be used to set the initial text of the text field once created. Defaults to empty if not specified.
          - :color: (Any) The color of the text field border.
          - :text_color: (Any) The text color of the text field.
          ...
          - :font_size: (Any) The size of the font to use for text (default 1.0).
          - :align: (Any) The text alignment to use. This can be left (default), right, or center.
        ...
        return str(res)
    def add_toggle(self, device: Any, x: Any, y: Any, text: Optional[str] = None, options: Optional[dict] = None) -> str:
        '''
        ...
        :options: Additional options
          - :style: (Any) The visual style of the toggle control. This can be switch (default) for a mobile-style toggle, or checkbox for a desktop-style toggle.
          - :id: (str) The id to use for the control. If not specified, a new one will be automatically generated.
          ...
          - :color: (Any) The color of the toggle itself.
          - :text_color: (Any) The text color of the toggle.
          - :font_size: (Any) The size of the font to use for text (default 1.0). Note that this will also scale up the size of the toggle itself (not just the text).
        ...
        return str(res)
    def add_touchpad(self, device: Any, x: Any, y: Any, width: Any, height: Any, options: Optional[dict] = None) -> str:
        '''
        ...
        :options: Additional options
          - :id: (str) The id to use for the control. If not specified, a new one will be automatically generated.
          - :event: (str) The name of a message type to be sent each time the user touches, slides, or lets go of the touchpad. A message field called tag is included to differentiate the different types of interactions; it is one of down (touch started), up (touch ended), or move (during continued/held touch). You must call PhoneIoT.listenToGUI to actually receive these messages. If not specified, no event is set. Message fields: id, x, y, tag.
          - :color: (Any) The color of the touchpad.
          - :style: (Any) Controls the appearance of the touchpad. These are the same as for PhoneIoT.addButton except that only rectangle and square are allowed.
          - :landscape: (bool) true to rotate the control 90 degrees into landscape mode.
        ...
        return str(res)
    def authenticate(self, device: Any):
        '''
    ...
    def clear_controls(self, device: Any):
        '''
    ...
    def get_accelerometer(self, device: Any) -> list:
        '''
    ...
    def get_altitude(self, device: Any) -> float:
        '''
        ...
        return float(res)
    def get_bearing(self, device: Any) -> float:
        '''
        ...
        return float(res)
    def get_color(self, red: Any, green: Any, blue: Any, alpha: Optional[Any] = None) -> Any:
        '''
    ...
    def get_compass_cardinal_direction(self, device: Any) -> str:
        '''
        ...
        return str(res)
    def get_compass_direction(self, device: Any) -> str:
        '''
        ...
        return str(res)
    def get_compass_heading(self, device: Any) -> float:
        '''
        ...
        return float(res)
    def get_facing_direction(self, device: Any) -> str:
        '''
        ...
        return str(res)
    def get_gravity(self, device: Any) -> list:
        '''
    ...
    def get_gyroscope(self, device: Any) -> list:
        '''
    ...
    def get_image(self, device: Any, id: str) -> dict:
        '''
        ...
        return dict(res)
    def get_level(self, device: Any, id: str) -> float:
        '''
        ...
        return float(res)
    def get_light_level(self, device: Any) -> float:
        '''
        ...
        return float(res)
    def get_linear_acceleration(self, device: Any) -> list:
        '''
    ...
    def get_location(self, device: Any) -> list:
        '''
    ...
    def get_magnetic_field(self, device: Any) -> list:
        '''
    ...
    def get_microphone_level(self, device: Any) -> list:
        '''
    ...
    def get_orientation(self, device: Any) -> list:
        '''
    ...
    def get_position(self, device: Any, id: str) -> list:
        '''
    ...
    def get_proximity(self, device: Any) -> float:
        '''
    ...
    def get_step_count(self, device: Any) -> float:
        '''
        ...
        return float(res)
    def get_text(self, device: Any, id: str) -> str:
        '''
        ...
        return str(res)
    def get_toggle_state(self, device: Any, id: str) -> bool:
        '''
        ...
        return bool(res)
    def is_pressed(self, device: Any, id: str) -> bool:
        '''
        ...
        return bool(res)
    def listen_to_gui(self, device: Any):
        '''
    ...
    def listen_to_sensors(self, device: Any, sensors: Optional[dict] = None):
        '''
        ...
        :sensors: structured data representing the minimum time in milliseconds between updates for each sensor type to listen for
          - :gravity: (Any) gravity period
          - :gyroscope: (Any) gyroscope period
          - :orientation: (Any) orientation period
          - :accelerometer: (Any) accelerometer period
          - :magnetic_field: (Any) magneticField period
          - :rotation: (Any) rotation period
          - :linear_acceleration: (Any) linearAcceleration period
          - :game_rotation: (Any) gameRotation sensor period
          - :light_level: (Any) lightLevel period
          - :microphone_level: (Any) microphoneLevel period
          - :proximity: (Any) proximity period
          - :step_count: (Any) stepCount period
          - :location: (Any) location period
        '''
    ...
    def normalize(self, vec: List[float]) -> List[float]:
        ...
        return vectorize(float)(res)
    def remove_control(self, device: Any, id: str):
        '''
    ...
    def set_credentials(self, device: Any, password: str):
        '''
    ...
    def set_image(self, device: Any, id: str, img: Any):
        '''
    ...
    def set_level(self, device: Any, id: str, value: float) -> float:
        '''
        ...
        return float(res)
    def set_text(self, device: Any, id: str, text: Optional[str] = None):
        '''
    ...
    def set_toggle_state(self, device: Any, id: str, state: bool):
        '''
...
class Twitter:
    ...
    def __init__(self, client):
        self._client = client
    def favorites(self, screen_name: str, count: float) -> list:
        '''
    ...
    def favorites_count(self, screen_name: str) -> float:
        '''
        ...
        return float(res)
    def followers(self, screen_name: str) -> float:
        '''
        ...
        return float(res)
    def recent_tweets(self, screen_name: str, count: float) -> list:
        '''
    ...
    def search(self, keyword: str, count: float) -> list:
        '''
    ...
    def tweets(self, screen_name: str) -> float:
        '''
