...
class NGC(object):
    ...
    def _check_cmd(self, cmd, *args):
        """
        runs a command and returns True/False.

        Internal routine that should only be used by state machine
        """
        msg, cmd_ok = self.cmd(cmd, *args)
        return cmd_ok
