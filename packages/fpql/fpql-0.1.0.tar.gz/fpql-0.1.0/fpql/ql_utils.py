...
def qlSchedule(issue_date: str, maturity: str, period: ql.QuantLib.Period, ql_calendar,
                business_day, maturity_business_day,
                date_gen, eom: bool = False):
    """
    ...
    schedule = ql.Schedule(vdate, mdate, period, ql_calendar, business_day,
                       maturity_business_day, date_gen, eom)
    return schedule
