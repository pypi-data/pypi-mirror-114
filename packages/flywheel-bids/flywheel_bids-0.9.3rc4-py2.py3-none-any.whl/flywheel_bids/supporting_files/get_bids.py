...
def get_bids_info(project, bc):
    ...
    for subject in project.subjects.iter_find():
        ...
        # Gather IntendedFor information here to be saved into a .csv file later.  Dictionary key for all
        # of these is the acquisition file name.
        intended_for_acq_label = dict()  # acquisition.label
        intended_for_acq_id = dict()  # acquisition.id
        intended_for_dirs = (
            dict()
        )  # any or all of [{"Folder": "anat"}, {"Folder": "func"}, {"Folder": "dwi"}]
        intended_fors = dict()  # [bids_relative_path1, bids_relative_path2, ...]
