...
class ClientConfig:
    def __init__(self):
        ...
        self.minio_access_key = os.environ.get('MINIO_ACCESS_KEY', '24WTCKX23M0MRI6BA72Y')
        self.minio_secret_key = os.environ.get('MINIO_SECRET_KEY', '6mxoQMf1Lha2q1H3fp3fjNHEZRJJ7LvbC5k3+CQX')
