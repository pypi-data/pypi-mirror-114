#ifndef LIBRAPID_NETWORK
#define LIBRAPID_NETWORK
...
#include <librapid/network/layers/affine.hpp>
#include <librapid/network/network_core.hpp>

#endif // LIBRAPID_NETWORK