...
mkdir -p /tmp/pg
chown postgres:postgres /tmp/pg
su postgres -s /bin/sh -c "kwollect-setup-db --chunk_interval_hour 1 --kwollect_password changeme --chunk_compress_hour $((24*365*10)) --request_timeout_min $((5*60)) --archive_path /tmp/pg"
