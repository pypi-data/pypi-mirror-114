...
def load_wwiii(var, kwargs):
    ...
    with index(dx=180, dy=90, dz=5000, dt=timedelta(days=1), storagedir=storage_cfg(), 
...
class Wwiii():
    ...
    def load_wind_uv(self,          **kwargs):
        with index(dx=180, dy=90, dz=5000, dt=timedelta(days=1), storagedir=storage_cfg(), **kwargs) as fetchmap:
