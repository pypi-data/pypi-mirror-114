...
class ReporterTestCase(unittest.TestCase):
    ...
    def test_indentical_with_dhash(self):
        self.use_image_hashing(first=self.base_screen_shot, second=self.base_screen_shot, name_executing_method=self._testMethodName, hash_method="dhash")

    def test_indentical_with_phash(self):
        self.use_image_hashing(first=self.base_screen_shot, second=self.base_screen_shot, name_executing_method=self._testMethodName, hash_method="phash")

    def test_indentical_with_ahash(self):
        self.use_image_hashing(first=self.base_screen_shot, second=self.base_screen_shot, name_executing_method=self._testMethodName, hash_method="ahash")

    def test_indentical_with_crhash(self):
    ...
    def test_indentical_with_whash(self):
        self.use_image_hashing(first=self.base_screen_shot, second=self.base_screen_shot,
                               name_executing_method=self._testMethodName, hash_method="whash")

    def test_indentical_with_dvhash(self):
        self.use_image_hashing(first=self.base_screen_shot, second=self.base_screen_shot,
