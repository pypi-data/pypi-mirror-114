...
assert_same_sub_schema(self_sigarrs1a + self_sigarrs2, seg1a.analogsignals)
assert_same_sub_schema(self_irsigs1a + self_irsigs2, seg1a.irregularlysampledsignals)
