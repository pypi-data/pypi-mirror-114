...
_UPDATENOTEREQUEST = _descriptor.Descriptor(
  ...
  full_name='anki.notes.UpdateNoteRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='note', full_name='anki.notes.UpdateNoteRequest.note', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='skip_undo_entry', full_name='anki.notes.UpdateNoteRequest.skip_undo_entry', index=1,
...
UpdateNoteRequest = _reflection.GeneratedProtocolMessageType('UpdateNoteRequest', (_message.Message,), {
  ...
  '__module__' : 'anki.notes_pb2'
  # @@protoc_insertion_point(class_scope:anki.notes.UpdateNoteRequest)
  })
...
_NOTESSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='UpdateNote',
    full_name='anki.notes.NotesService.UpdateNote',
    index=4,
    containing_service=None,
