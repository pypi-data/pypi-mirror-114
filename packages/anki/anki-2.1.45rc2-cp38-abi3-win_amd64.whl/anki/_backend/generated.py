...
class RustBackendGenerated:
    ...
    def update_note(self, *, note: anki.notes_pb2.Note, skip_undo_entry: bool) -> anki.collection_pb2.OpChanges:
        input = anki.notes_pb2.UpdateNoteRequest(note=note, skip_undo_entry=skip_undo_entry)
        output = anki.collection_pb2.OpChanges()
    ...
    def add_or_update_notetype(self, *, json: bytes, preserve_usn_and_mtime: bool) -> int:
        input = anki.notetypes_pb2.AddOrUpdateNotetypeRequest(json=json, preserve_usn_and_mtime=preserve_usn_and_mtime)
        output = anki.notetypes_pb2.NotetypeId()
    ...
    def update_card(self, *, card: anki.cards_pb2.Card, skip_undo_entry: bool) -> anki.collection_pb2.OpChanges:
        input = anki.cards_pb2.UpdateCardRequest(card=card, skip_undo_entry=skip_undo_entry)
        output = anki.collection_pb2.OpChanges()
