...
def _normalize_inputs(
    ...
    ids, pred_labels_df, actual_labels_df, features_df, time_df = (
        None,
        None,
        None,
        None,
...
def _build_value_map(vals):
    ...
    if isinstance(vals, dict):
        ...
        formatted = vals.apply(lambda y: y.apply(lambda x: _tranform_value(x, y.name)))
    return formatted
