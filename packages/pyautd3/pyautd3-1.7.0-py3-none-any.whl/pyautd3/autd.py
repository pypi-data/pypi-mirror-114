...
class PointSequence(Sequence):
    ...
    def add_point(self, point):
        return NATIVE_METHODDS.autd3capi.AUTDSequenceAddPoint(self.seq_ptr, point[0], point[1], point[2])
    ...
    def add_points(self, points):
        ...
        return NATIVE_METHODDS.autd3capi.AUTDSequenceAddPoints(self.seq_ptr, points_array, size)
