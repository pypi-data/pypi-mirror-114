...
startup = input(
    "1) Generate StringSession (Linux Only)\n2) Install Ultroid\n\nWhat Would you like to do? (1,2) : "
)
...
if startup == 1:
    subprocess.run(["wget", "https://raw.githubusercontent.com/TeamUltroid/Ultroid/main/resources/session/session.sh"], check=True)
