...
class LocationSettingsChild(Model):
    ...
    :param assign_filters_to_location:
    :type assign_filters_to_location: bool
    ...
    _attribute_map = {
        ...
        'assign_filters_to_location': {'key': 'AssignFiltersToLocation', 'type': 'bool'},
        'external_notification_type': {'key': 'ExternalNotificationType', 'type': 'str'},
    }

    def __init__(self, *, max_transport_interval: int=None, max_vibration_update_interval: int=None, max_oil_quality_update_interval: int=None, opc_enabled: bool=None, assign_filters_to_location: bool=None, external_notification_type=None, **kwargs) -> None:
