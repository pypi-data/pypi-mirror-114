...
class TreeItemResponse(Model):
    ...
    :param children:
    :type children: list[~smartdiagnostics_sdk.models.TreeItemDescendantChild]
    :param hierarchy:
    ...
    _attribute_map = {
        ...
        'has_alarms': {'key': 'HasAlarms', 'type': 'bool'},
        ...
        'children': {'key': 'Children', 'type': '[TreeItemDescendantChild]'},
