...
class ReceiverChild(Model):
    ...
    def __init__(self, *, receiver_id: int, receiver_serial_number: str, receiver_name: str=None, receiver_firmware_version: str=None, receiver_network_id: str=None, receiver_rf_channel: int=None, receiver_pending_rf_channel: int=None, **kwargs) -> None:
