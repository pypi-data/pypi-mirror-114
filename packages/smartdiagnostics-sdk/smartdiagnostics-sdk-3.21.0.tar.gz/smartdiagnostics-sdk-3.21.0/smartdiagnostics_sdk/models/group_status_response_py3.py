...
class GroupStatusResponse(Model):
    ...
    _attribute_map = {
        ...
        'model_count': {'key': 'ModelCount', 'type': 'int'},
        'analytics_models': {'key': 'AnalyticsModels', 'type': '[AnalyticsModelChild]'},
        'hierarchy': {'key': 'Hierarchy', 'type': '[HierarchyChild]'},
    }

    def __init__(self, *, name: str, id: str, alarm_count: int, warning_count: int, is_snoozed: bool, is_paused: bool, model_count: int, damage_score: float=None, alarm_severity: int=None, analytics_models=None, hierarchy=None, **kwargs) -> None:
