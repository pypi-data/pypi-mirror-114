...
class AnalyticsModelResponse(Model):
    ...
    def __init__(self, *, id: str, name: str, version: str, type, created, is_global: bool, is_deprecated: bool, group_type=None, last_upload=None, error_type=None, disable_date=None, indicators=None, properties=None, related_models=None, created_by=None, corporation=None, location=None, triggers=None, tags=None, **kwargs) -> None:
