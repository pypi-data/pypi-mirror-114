...
class AnalyticsModelChild(Model):
    ...
    _attribute_map = {
        'analytics_model_id': {'key': 'AnalyticsModelId', 'type': 'str'},
        'analytics_model_name': {'key': 'AnalyticsModelName', 'type': 'str'},
        'analytics_model_version': {'key': 'AnalyticsModelVersion', 'type': 'str'},
    }

    def __init__(self, *, analytics_model_id: str, analytics_model_name: str, analytics_model_version: str, **kwargs) -> None:
