...
class MonitoringPointOverviewResponse(Model):
    ...
    :param bearing_assignment:
    :type bearing_assignment: ~smartdiagnostics_sdk.models.BearingChild
    """
    ...
    _attribute_map = {
        ...
        'bearing_assignment': {'key': 'BearingAssignment', 'type': 'BearingChild'},
    }

    def __init__(self, *, id: str, name: str, is_paused: bool, is_snoozed: bool, monitoring_point_type=None, running_speed_multiplier: float=None, node=None, hierarchy=None, node_settings=None, bearing_assignment=None, **kwargs) -> None:
