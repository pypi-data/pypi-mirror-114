...
class AssetRunningSpeedChild(Model):
    ...
    def __init__(self, *, running_speed_min: float=None, running_speed_max: float=None, running_speed_type: str=None, running_speed_unit: str=None, running_speed_reference_monitoring_point_id: str=None, running_speed_sensor_role_type=None, running_speed_harmonic: float=None, **kwargs) -> None:
