...
class ReceiverResponse(Model):
    ...
    def __init__(self, *, id: int=None, serial_number: str=None, firmware_version: str=None, network_id: str=None, receiver_type=None, rf_channel: int=None, pending_rf_channel: int=None, mac_address: str=None, radio_mac_address: str=None, location=None, corporation=None, nodes=None, name: str=None, **kwargs) -> None:
