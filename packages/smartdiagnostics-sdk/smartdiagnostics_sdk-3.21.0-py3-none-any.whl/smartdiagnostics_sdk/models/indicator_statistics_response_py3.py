...
class IndicatorStatisticsResponse(Model):
    ...
    def __init__(self, *, id: str, name: str, indicator_type, system_sort_order: int=None, measure_of=None, display_units: str=None, last_measurement=None, average_value: float=None, max_value: float=None, time_in_alarm: float=None, time_in_warning: float=None, on_time: float=None, hierarchy=None, start_date=None, end_date=None, **kwargs) -> None:
