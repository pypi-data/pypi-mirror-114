...
class IndicatorResponse(Model):
    ...
    def __init__(self, *, id: str, name: str, abbreviation: str=None, system_sort_order: int=None, indicator_type=None, measure_of=None, display_units: str=None, base_units: str=None, has_spectrum: bool=None, meta_data: str=None, damage_exponent: int=None, hierarchy=None, alarm_definition=None, band_definition=None, baseline=None, **kwargs) -> None:
