...
class BaseStationResponse(Model):
    ...
    def __init__(self, *, id: int, serial_number: str, name: str=None, location=None, corporation=None, last_status_update=None, push_to_stage: bool=None, release_ring=None, targeted_software_release=None, current_software_release=None, hardware_revision=None, receiver=None, last_data_update=None, is_online: bool=None, **kwargs) -> None:
