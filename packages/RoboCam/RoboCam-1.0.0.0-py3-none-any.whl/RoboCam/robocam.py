...
# from lib.peppa.core.api import face_detector, face_landmark
# face detector libs
from face_detector import FaceDetector
from face_landmark import FaceLandmark
from face_recognizer import FaceRecognizer
from aruco_detector import ArucoDetctor
...
class RoboCam():
    ...
    def leftrightFlipMode(self):
        self.flipLRFlag = not self.flipLRFlag
    
    def updownFlipMode(self):
        self.flipUDFlag = not self.flipUDFlag
        ...
        while self.streamFlag:
            ...
            try:
                ...
                if a != -1 and b != -1:
                    ...
                    t2 = time.time()
                    s = f"""{int(1/(t2-t1))} FPS"""
                    cv2.putText(frame, s, org, font, 1, (0,0,255), 2)
                    cv2.imshow('i', frame)
                    cv2.waitKey(1)
    ...
    def FaceCapture(self, name:str, path:str='./RoboCam/res/face/'):
        if bool(name) == False:
    ...
    def TrainFaceData(self, facePath:str = './RoboCam/res/face/'):
    ...
    def arucoDetectorInit(self):
        ...
        print("Arucodetector initialized")
    
    def arucoDetectorStart(self):
        if self.arucoDetectInitFlag is False:
            print("Arucodetector is not initialized")
            return

        if self.arucoDetectFlag == True:
            print("Arucodetector is already working.")
            return
    ...
    def sketchdetectorInit(self):
        ...
        print("Sketchdetector initialized")
    
    def sketchdetectStart(self):
        if self.sketchDetectInitFlag is False:
            print("Sketchdetector is not initialized")
            return

        if self.sketchDetectFlag == True:
            print("Sketchdetector is already working.")
            return
    ...
    def sketchdetectStop(self):
        if self.sketchDetectFlag == False :
            print("Sketchdetector is already stopped.")
            return
    ...
    def SketchCapture(self, name:str, path:str='./RoboCam/res/sketch/'):
        if bool(name) == False:
            print("Name parameter is Empty.")
            return
    ...
    def TrainSketchData(self, sketchPath:str = './RoboCam/res/sketch/'):
    ...
    def DelteFaceData(self, name:str, sketchPath:str='.res/sketch/'):

        if os.path.isdir(sketchPath) is False:
            print(sketchPath +" is not directory.")
            return

        self.faceR.RemoveFace(name, sketchPath)
    ...
    def numberRecognizerInit(self):
        ...
        print("Numberrecognizer initialized")
    def numberRecognizerStart(self):
        if self.numberDetectInitFlag is False:
            print("Numberrecognizer is not initialized")
            return

        if self.numberDetectFlag == True:
            print("Numberrecognizer is already working.")
            return
