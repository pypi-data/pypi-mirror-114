...
class SketchRecognizer:
    def __init__(self) -> None:
        ...
        self.sketchPath = './RoboCam/res/sketch/'
        self.orbDescriptors = []
        self.nameIndexList = []
        self.nameIntList = []
    ...
    def SaveSketch(self, image, name:str, sketchPath:str ='./RoboCam/res/sketch/'):
    ...
    def RemoveSketch(self, name:str, sketchPath:str='./RoboCam/res/sketch/'):
        if os.path.isdir(sketchPath) is False:
            print( sketchPath +" is not directory.")
            return
