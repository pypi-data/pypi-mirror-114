...
class ModelManager:
    ...
    def set_credentials(
        ...
        grant_type: Union[str, None] = os.environ.get(
            "MODEL_MANAGER_GRANT_TYPE", None),
        client_id: Union[str, None] = os.environ.get(
            "MODEL_MANAGER_CLIENT_ID", None),
        client_secret: Union[str, None] = os.environ.get(
            "MODEL_MANAGER_CLIENT_SECRET", None),
        scope: Union[str, None] = os.environ.get("MODEL_MANAGER_SCOPE", None),
        container: Union[str, None] = os.environ.get(
            "MODEL_MANAGER_CONTAINER", None),
        login_url: Union[str, None] = os.environ.get(
            "MODEL_MANAGER_LOGIN_URL", None),
        get_files_url: Union[str, None] = os.environ.get(
            "MODEL_MANAGER_GET_FILES_URL", None),
        download_file_url: Union[str, None] = os.environ.get(
            "MODEL_MANAGER_DOWNLOAD_FILE_URL", None),
        default_tenant_name: Union[str, None] = os.environ.get(
            "STS_APPLICATION_DEFAULT_TENANT_NAME", None)
    ) -> None:
    ...
    def __download_model_dataservices(cls, model: Dict[str, str]) -> None:
        ...
        matched_models = [
            f for f in cls._available_files if f.startswith(query)]
