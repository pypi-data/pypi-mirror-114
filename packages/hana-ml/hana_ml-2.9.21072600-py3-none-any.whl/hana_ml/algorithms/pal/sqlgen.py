...
def call_pal_tabvar(name, sql_tracer, parallel_by_parameter_partitions, *args): # SQLTRACE added sql_tracer
    """
    ...
    if parallel_by_parameter_partitions:
        invocation = 'CALL _SYS_AFL.{}({}) WITH HINT (PARALLEL_BY_PARAMETER_PARTITIONS(p1));\n'\
            .format(name, ', '.join(pal_args))
