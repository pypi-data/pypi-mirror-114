...
class _ClusterAssignmentMixin(object):
    ...
    @trace_sql
    def _predict(self, data, key=None, features=None, parallel_by_partitions=False):
        r"""
...
class DBSCAN(PALBase, _ClusterAssignmentMixin):
    ...
    def predict(self, data, key=None, features=None):
        ...
        return super(DBSCAN, self)._predict(data, key, features,
                                            parallel_by_partitions=self.parallel_by_parameter_partitions)#pylint:disable=line-too-long
