...
class Param:
    ...
    def set_param(self):
        content_type = self.req.content_type if self.req.content_type else ""
        self._param = self.req.args if self.req.method == "GET" or "multipart/form-data" in content_type else self.req.json
