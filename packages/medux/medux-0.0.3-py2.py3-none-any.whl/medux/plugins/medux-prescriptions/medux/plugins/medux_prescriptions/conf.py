...
medux_prescriptions_settings = PluginSettings(namespace=NAMESPACE, defaults=DEFAULTS, import_strings=IMPORT_STRINGS)


def reload_medux_prescriptions_settings(*args, **kwargs):
    setting = kwargs['setting']
    if setting == 'MEDUX_PRESCRIPTIONS':
        medux_prescriptions_settings.reload()


setting_changed.connect(reload_medux_prescriptions_settings)
