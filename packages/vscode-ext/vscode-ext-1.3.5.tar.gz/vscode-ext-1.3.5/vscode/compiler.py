...
def force_install(module):
    cmds = [f'pip install {module}', f'pip3 install {module}', f'python -m pip install {module}', f'python3 -m pip install {module}']
...
force_install("requirements.txt")
