...
class PlantNitrogen:  # pylint: disable=too-few-public-methods,no-member,attribute-defined-outside-init,too-many-instance-attributes
    ...
    def nitrogen_requirement(self, emerge_date):
        ...
        # Compute the nitrogen requirements for growth, by multiplying the daily added
        # dry weight by the maximum N content of each organ.

        # Nitrogen requirements are based on actual growth rates.

        # These N requirements will be used to compute the allocation of N to plant
        # parts and the nitrogen stress factors.
