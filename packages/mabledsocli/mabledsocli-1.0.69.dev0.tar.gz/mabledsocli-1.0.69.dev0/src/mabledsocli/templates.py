...
class TemplateManager():
    ...
    def get_template_render_path(self, key):
        ...
        if not result:
            result = f'.{os.sep}' + os.path.relpath(os.path.join(Templates.default_render_path, key), Configs.working_dir) 
    ...
    def render(self, stage, filter=None):
        ...
        jinja_env = jinja2.Environment(loader=jinja2.FileSystemLoader(Configs.working_dir), undefined=jinja2.StrictUndefined)
