...
class ConfigManager:
    ...
    def project(self):
        if 'project' in self.overriden_config:
            result = self.overriden_config['project'].lower()
        
        elif 'project' in self.local_config:
            result = self.local_config['project'].lower()

        elif 'DSO_PROJECT' in os.environ:
            result = os.getenv('DSO_PROJECT').lower()

        elif 'project' in self.merged_config:
            result = self.merged_config['project'].lower()
