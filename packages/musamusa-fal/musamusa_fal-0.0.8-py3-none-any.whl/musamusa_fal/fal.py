...
class FileAndLine(Iaswn):
    ...
    # @staticmethod
    # def _from_jsondict(json_dict):
    #     """
    #         FileAndLine._from_jsondict()

    #         Internal method: transform <json_dict> into a FileAndLine object.
    #         ___________________________________________________________________

    #         ARGUMENT:
    #         o  json_dict: (dict) dictionary filled with JSON data

    #         RETURNED VALUE: a FileAndLine object
    #     """
    #     return FileAndLine(filename=json_dict["filename"],
    #                        lineindex=json_dict["lineindex"]
    #                        )

    # @staticmethod
    # def _to_jsondict(obj):
    #     """
    #         FileAndLine._to_jsondict()
