...
* Allowing engine functions as first parameter as in SQLAlchemy
...
def connect(
    ...
    engine: either an arbitrary function returning new DB-API 2 compliant
    ...
    args, kwargs: the parameters that shall be passed to the engine
