            ...
            for i in Scene.GameObjects[Scene.now]:
                if i.type == "GameObject" or i.type == "EmptyObject":
                    if i != paren:
                        crash = False
                        direct = Vector2()
                        if (i.transform.position.x - i.size.x / 2 + 2) >= (paren.tranform.porition.x + paren.size.x / 2) >= (i.transform.position.x - i.size.x / 2):
                            if ((i.transform.position.y - i.size.y / 2 + 2) <= (paren.tranform.porition.y - paren.size.y / 2) <= (i.transform.position.y + i.size.y / 2 - 2)) 
                            or ((i.transform.position.y - i.size.y / 2 + 2) <= (paren.tranform.porition.y + paren.size.y / 2) <= (i.transform.position.y + i.size.y / 2 - 2)):
                                direct = (1, 0)
                                crash = True
                            elif (i.transform.position.y + i.size.y / 2) <= (paren.tranform.porition.y - paren.size.y / 2) <= (i.transform.position.y):
                                direct = (1, -1)
                                crash = True
                            else:
                                direct = (1, 1)
                                crash = True
                        elif (i.transform.position.x + i.size.x / 2 - 2) >= (paren.tranform.porition.x - paren.size.x / 2) >= (i.transform.position.x + i.size.x / 2):
                            if ((i.transform.position.y - i.size.y / 2 + 2) <= (paren.tranform.porition.y - paren.size.y / 2) <= (i.transform.position.y + i.size.y / 2 - 2)) 
                            or ((i.transform.position.y - i.size.y / 2 + 2) <= (paren.tranform.porition.y + paren.size.y / 2) <= (i.transform.position.y + i.size.y / 2 - 2)):
                                direct = (-1, 0)
                                crash = True
                            ...
                            if (i.transform.position.y + i.size.y / 2) <= (paren.tranform.porition.y - paren.size.y / 2) <= (i.transform.position.y):
                                direct = (0, -1)
                                crash = True
                            else:
                                direct = (0, 1)
                                crash = True
                        if crash:
                            crash_object.append(i)
                            crash_direction.append(direct)
