                ...
                if i.type == "GameObject" or i.type == "EmptyObject":
                    if i != paren:
                        ...
                        if (i.transform.position.x - i.size.x / 2 + 2) >= (paren.tranform.porition.x + paren.size.x / 2) >= (i.transform.position.x - i.size.x / 2):
                            if ((i.transform.position.y - i.size.y / 2 + 2) <= (paren.tranform.porition.y - paren.size.y / 2) <= (i.transform.position.y + i.size.y / 2 - 2)) or \
                                ((i.transform.position.y - i.size.y / 2 + 2) <= (paren.tranform.porition.y + paren.size.y / 2) <= (i.transform.position.y + i.size.y / 2 - 2)):
                                direct = (1, 0)
                                crash = True
