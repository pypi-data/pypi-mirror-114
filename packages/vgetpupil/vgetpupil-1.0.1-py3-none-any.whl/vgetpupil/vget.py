...
def main():
    ...
    if str(input_file).endswith(".mp4"):
        ...
        if "left" in str(input_file).lower():
            eye_side_input = 0
        elif "right" in str(input_file).lower():
            eye_side_input = 1
        else:
            print("Input file name must contain \"left\" or \"right\" inorder to write csv.")
            convert_able = False
    else:
        convert_able = False
