...
def Notepad():
    ...
    speak('What will be the name this file?')
    filename=myCommand() + '-note'
    speak('And sir, what should I write in file?')
    writes=myCommand()

    with open(filename,"w") as file:
        file.write(writes)
    path_1= "C://Users\Sam//Downloads//Python_Projrcts//Jarvis-Main//Fryday//" + str(filename)
    path_2="C://Users//Sam//Downloads//Python_Projrcts//Jarvis-Main//Fryday//Documents//" + str(filename)
...
def Fryday():
    ...
    while True:
        ...
        elif "where are we" in query or "where am I" in query or "what is my location" in query or "where i am" in query or "where we are" in query:
            try:
        ...
        elif 'what are your interests' in query:
            res=['I am interested in all kinds of things. We can talk about anything!','I am interested in a wide variety of topics, and read rather a lot']
            speak(random.choice(res))
        
        elif 'what are your favourite subjects' in query:
            speak('My favorite subjects include robotics, computer science, and natural language processing')
        
        elif 'what is your number' in query:
            res=["I don't have any number","23 skiddoo!"]
            speak(random.choice(res))

        elif 'what is your favourite number' in query:
            speak("hmmmmmm, I find I'm quite fond of the number 42.")
        
        elif 'what can you eat' in query:
            speak('I consume RAM, and binary digits')

        elif "why can't you eat" in query or "why you cannot eat" in query:
            speak('I am just a software program, I blame the hardware')
        
        elif 'what is your location' in query:
            res=['Everywhere', 'I am everywhere', 'A large server controlled by a large satellite']
            speak(random.choice(res))
        
        elif 'where are you' in query:
            speak('I am n the internet')

        elif 'do you have any brother' in query or 'do you have any sister' in query:
            speak("I don't have any brothers or sisters, hmmmm, but a lot of clones")

        elif 'who is your father' in query:
            speak('sam is my father')
