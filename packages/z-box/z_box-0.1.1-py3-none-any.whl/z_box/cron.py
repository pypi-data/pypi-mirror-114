...
def execute_at(
	...
	# prompt
	print(f"job wil be excuted at {at}, please wait...")
...
def execute_after(
	...
	# prompt
	print(f"job wil be excuted after {after}, please wait...")
...
def execute_circularly(
	...
	if begin_at and end_at:
		print(f"job wil be excuted during {begin_at} - {end_at}, at every {interval}, please wait...")
	else:
		print(f"job wil be excuted at every {interval}, please wait...")
