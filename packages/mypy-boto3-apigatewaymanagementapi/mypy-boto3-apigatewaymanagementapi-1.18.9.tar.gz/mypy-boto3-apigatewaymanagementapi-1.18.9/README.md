...
[boto3.ApiGatewayManagementApi 1.18.9](https://boto3.amazonaws.com/v1/documentation/api/1.18.9/reference/services/apigatewaymanagementapi.html#ApiGatewayManagementApi)
