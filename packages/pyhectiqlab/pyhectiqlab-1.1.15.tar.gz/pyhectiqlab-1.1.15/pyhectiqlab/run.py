...
class Run():
    ...
    @write_method
    def add_artifacts(self, filepath: str, step: int = None, wait_response: bool = False):
        ...
        return self.events_manager.add_event("add_file", args, async_method=bool(1-wait_response))
    ...
    def add_dataset_usage_from_dirpath(self, dirpath:str):
        """Log that this run is using a certain dataset. 
        """
