...
_responce_type = NewType('_responce_type', str)
...
class Executor:
    ...
    def execute_request(self, params: Union[Dict, str], method: str = "POST") -> _responce_type:
        """
        ...
        if method == "GET":
            ...
            if command_state in ((210, 14), (502, 5), (503, 6), (503, 24), (505, 4)):
