...
class ClusterSets(Sequence) :
    ...
    def plot(self, axs=None, coloring="consistent",  with_silhouettes=False, with_n_clusters=False) :
    ...
    def plot_and_format_with_average_silhouettes(self, axs, events, phases, time_ticks=None, coloring="consistent"):
        ...
        self.plot(axs=(ax1, ax2, ax3), coloring=coloring, with_silhouettes=True, with_n_clusters=True)
