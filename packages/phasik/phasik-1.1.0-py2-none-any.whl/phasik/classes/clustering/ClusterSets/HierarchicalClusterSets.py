"""
Base class for HierarchicalClusterSets
"""

from phasik.classes.clustering.ClusterSet import HierarchicalClusterSet
from phasik.classes.clustering.ClusterSets import ClusterSets

__all__ = ['HierarchicalClusterSets']
