...
class SimpleSlide(BaseTrader):
    """SimpleSlide trader
    Auto-adjust away from buy_barrier if price is going down. This helps prevent using to much of
    your available money during a large initial drop. For example, you could expend all available
    USD during the first 10% drop of a 20% total drop.
    Increment in 0.25 increments.
    """
    ...
    def __init__(self, config) -> None:
        ...
        # history of (barrier_used, price)
        self._barrier_history = deque(maxlen=6)
