...
from common.views import RESTResponse
from django.http import HttpResponse, JsonResponse
from django.utils.deprecation import MiddlewareMixin
import json
from common.logging_config import get_my_logger, DOCUMENTPATH
from common.response_param import Results, REQUEST_ERROR_CODE, FORBID_CODE, UNAUTHORIZED

logger = get_my_logger(DOCUMENTPATH, "django")
