...
class DateTimePickerWidget(DateTimeInput):
    ...
    def __init__(self, attrs=None, date_format="YYYY-MM-DD HH:mm"):
        super().__init__(attrs, date_format)
    ...
    def __init__(self, attrs=None, date_format="YYYY-MM-DD HH:mm"):
        ...
        widgets = (
            DateTimePickerWidget(
                attrs={"placeholder": "From", **attrs}, date_format=date_format
            ),
            DateTimePickerWidget(attrs={"placeholder": "To", **attrs}, date_format=date_format),
        )
