...
@LastEditTime: 2021-07-23 09:20:42
...
class AssetBase():
    ...
    def update_user_asset(self, app_id, act_id, module_id, user_id, open_id, user_nick, asset_type, asset_value, asset_object_id, source_type, source_object_id, source_object_name, log_title, only_id="", info_json={}, sub_table=None):
        ...
        only_redis_key = ""
        if only_id:
            only_redis_key = f"asset_only_list:{app_id}_{SevenHelper.get_now_day_int()}"
    ...
    def get_asset_warn_list(self, app_id, act_id, user_id, asset_type, page_size=20, page_index=0, asset_object_id="", start_date="", end_date="", user_nick="", open_id="", field="*"):
        """
