...
@LastEditTime: 2021-07-28 15:22:34
...
class ThemeInfoHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        act_info_dict = act_base_model.get_act_info_dict_cache(act_id)
...
class ThemeInfoListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        app_id = self.get_param("app_id")
        theme_base_model = ThemeBaseModel(context=self)
        return self.reponse_json_success(theme_base_model.get_theme_list_cache(app_id))
...
class SkinInfoListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        theme_out_id = self.get_param("theme_out_id")
        theme_base_model = ThemeBaseModel(context=self)
        return self.reponse_json_success(theme_base_model.get_skin_list_cache(theme_out_id))