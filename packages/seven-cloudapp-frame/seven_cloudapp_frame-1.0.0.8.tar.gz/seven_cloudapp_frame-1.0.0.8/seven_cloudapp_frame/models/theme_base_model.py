...
@LastEditTime: 2021-07-27 17:29:30
...
class ThemeBaseModel():
    ...
    def get_theme_info(self,theme_id, ver_no):
        ...
        """
        redis_key = f"theme_info:{theme_id}_{ver_no}"
        ...
        redis_init.set(redis_key,SevenHelper.json_dumps(theme_info_dict), ex=config.get_value("model_expire", 60 * 1))
        return theme_info_dict
    ...
    def get_or_add_theme(self, app_id, theme_name, client_json, server_json, out_id, ver_no):
        """
        :description: 添加或修改主题
        :param app_id：app_id
    ...
    def get_or_add_skin(self, app_id, skin_name, client_json, server_json, theme_out_id, skin_out_id):
        """
        :description: 保存皮肤
        :param app_id：应用标识
