...
method_signature = _descriptor.FieldDescriptor(
  ...
  serialized_options=None, json_name='methodSignature', file=DESCRIPTOR)
...
default_host = _descriptor.FieldDescriptor(
  ...
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
  serialized_options=None, json_name='defaultHost', file=DESCRIPTOR)
...
oauth_scopes = _descriptor.FieldDescriptor(
  ...
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
  serialized_options=None, json_name='oauthScopes', file=DESCRIPTOR)
