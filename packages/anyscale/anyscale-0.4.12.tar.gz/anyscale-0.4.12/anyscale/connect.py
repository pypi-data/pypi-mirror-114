...
from anyscale.api import configure_open_api_client_headers, get_api_client
...
class ClientBuilder:
    ...
    def _init_args(self, **kwargs) -> "ClientBuilder":  # noqa: C901
        ...
        Raises RuntimeError on unknown argument names.
        """
        unknown = []
        ...
        build_from_source_commit = kwargs.pop("build_commit", None)
        build_from_source_pr_id = kwargs.pop("build_source", None)
        ...
        for arg_name, value in kwargs.items():
            if self._parse_arg_as_method(arg_name, value):
                ...
                if isinstance(value, str):
                    # Autosuspend can take strings like "15", "15m", and "2h"
                    if value.endswith("m"):
        ...
        if unknown:
            ...
            raise RuntimeError(f"Unknown arguments: {unknown_str}")
    ...
    def _parse_arg_as_method(self, argument_name: str, argument_value: Any):
        """
