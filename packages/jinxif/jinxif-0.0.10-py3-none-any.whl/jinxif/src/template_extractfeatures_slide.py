...
poke_ddd_slide_marker_exposuretime_correct = peek_ddd_slide_marker_exposuretime_correct
...
feat.extract_features(
    ...
    ddd_slide_marker_exposuretime_correct = poke_ddd_slide_marker_exposuretime_correct,
