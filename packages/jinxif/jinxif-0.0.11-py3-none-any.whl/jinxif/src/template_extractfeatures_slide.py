...
poke_ddd_slidepxscene_marker_exposuretime_correct = peek_ddd_slidepxscene_marker_exposuretime_correct
...
feat.extract_features(
    ...
    ddd_slidepxscene_marker_exposuretime_correct = poke_ddd_slidepxscene_marker_exposuretime_correct,
