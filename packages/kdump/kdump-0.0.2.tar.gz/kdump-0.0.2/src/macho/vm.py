__all__ = ['vm_obj', 'VirtualMemoryMap']
...
class VirtualMemoryMap:
    ...
    def __str__(self):
        ...
        for (key, obj) in sortedmap.items():
            ...
            ret += f'{key.ljust(16)}  ||  Start: 0x{hex(obj.vmaddr)[2:].zfill(9)}  |  End: 0x{hex(obj.vmend)[2:].zfill(9)}  |  Size: 0x{hex(obj.size)[2:].zfill(9)}  |  File ' \
