...
def get_path_callback(inquiry_message: str, default: str):
    def path_callback(ctx: Context, source_path: str) -> str:
        return source_path or inquire_text(inquiry_message, default)

    return path_callback


def dest_path_callback(ctx: Context, dest_path: str) -> str:
    if dest_path:
        return dest_path
