...
from django_graphene_authentication.conf import settings as jwt_settings
...
refresh_expiration = get_refresh_expiration_decorator(jwt_settings.JWT_REFRESH_EXPIRATION_DELTA)
ensure_refresh_token = get_ensure_refresh_token_decorator(jwt_settings.JWT_REFRESH_TOKEN_COOKIE_NAME)
