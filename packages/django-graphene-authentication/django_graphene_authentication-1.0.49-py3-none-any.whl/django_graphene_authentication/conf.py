...
from django_graphene_authentication import utils
from django_graphene_authentication.refresh_token.models import StandardRefreshToken
...
class DjangoGraphQLApiTokenAppConf(AppConf):
    ...
    JWT_REFRESH_TOKEN_MODEL: type = "django_graphene_authentication.refresh_token.models.StandardRefreshToken"
    ...
    """
    If tokenre fresh is allowed, the refresh expiuration for the token generated by AbstractAccessTokenGeneratorMutationCreator
    """
