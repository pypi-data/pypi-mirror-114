...
def get_authentication_token_from_http_authorization(request: HttpRequest, token_authentication_header_name: str = None, jwt_auth_header_prefix: str = None) -> str:
    """
