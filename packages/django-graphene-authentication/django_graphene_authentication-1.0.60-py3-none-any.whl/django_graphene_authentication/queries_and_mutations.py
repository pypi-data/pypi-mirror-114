...
class AbstractTokenGeneratorMutationCreator(AbstractGrapheneMutationCreator):
    ...
    def login_mutation_body(self, mutation_instance, info, *args, **kwargs):
        return get_csrf_rotation_decorator(self.jwt_csrf_rotation())(
            get_refresh_expiration_decorator(self.jwt_token_expiration_time(), self.jwt_refresh_expires_in_name())(
