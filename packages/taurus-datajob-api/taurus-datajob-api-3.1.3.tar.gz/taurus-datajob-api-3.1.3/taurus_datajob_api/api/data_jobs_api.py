...
class DataJobsApi(object):
    ...
    def data_job_delete(self, team_name, job_name, **kwargs):  # noqa: E501
        ...
        <i>(Introduced in v1.0)</i> | Delete data Data Job including all its state (properties) and any deloyments. Currently executing Data Jobs will be left to finish.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
