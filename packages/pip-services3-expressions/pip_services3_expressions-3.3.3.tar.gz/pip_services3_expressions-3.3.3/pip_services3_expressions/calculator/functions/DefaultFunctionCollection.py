...
class DefaultFunctionCollection(FunctionCollection):
    ...
    def __init__(self):
        ...
        self.add(DelegatedFunction("Ticks", self._ticks_function_calculator, self))
        self.add(DelegatedFunction("TimeSpan", self._time_span_function_calculator, self))
        self.add(DelegatedFunction("Now", self.__now_function_calculator, self))
        self.add(DelegatedFunction("Date", self.__date_function_calculator, self))
        self.add(DelegatedFunction("DayOfWeek", self.__day_of_week_function_calculator, self))
        self.add(DelegatedFunction("Min", self.__min_function_calculator, self))
        self.add(DelegatedFunction("Max", self.__max_functional_calculator, self))
        self.add(DelegatedFunction("Sum", self.__sum_function_calculator, self))
        self.add(DelegatedFunction("If", self.__if_function_calculator, self))
        self.add(DelegatedFunction("Choose", self.__choose_function_calculator, self))
        self.add(DelegatedFunction("E", self.__e_function_calculator, self))
        self.add(DelegatedFunction("Pi", self.__pi_function_calculator, self))
        self.add(DelegatedFunction("Rnd", self.__rnd_function_calculator, self))
        self.add(DelegatedFunction("Random", self.__rnd_function_calculator, self))
        self.add(DelegatedFunction("Abs", self.__abs_function_calculator, self))
        self.add(DelegatedFunction("Acos", self.__acos_functional_calculator, self))
        self.add(DelegatedFunction("Asin", self.__asin_functional_calculator, self))
        self.add(DelegatedFunction("Atan", self.__atan_functional_calculator, self))
        self.add(DelegatedFunction("Exp", self.__exp_functional_calculator, self))
        self.add(DelegatedFunction("Log", self.__log_functional_calculator, self))
        self.add(DelegatedFunction("Ln", self.__log_functional_calculator, self))
        self.add(DelegatedFunction("Log10", self.__log10_functional_calculator, self))
        self.add(DelegatedFunction("Ceil", self.__ceil_functional_calculator, self))
        self.add(DelegatedFunction("Ceiling", self.__ceil_functional_calculator, self))
        self.add(DelegatedFunction("Floor", self.__floor_functional_calculator, self))
        self.add(DelegatedFunction("Round", self.__round_functional_calculator, self))
        self.add(DelegatedFunction("Trunc", self.__trunc_functional_calculator, self))
        self.add(DelegatedFunction("Truncate", self.__trunc_functional_calculator, self))
        self.add(DelegatedFunction("Cos", self.__cos_functional_calculator, self))
        self.add(DelegatedFunction("Sin", self.__sin_functional_calculator, self))
        self.add(DelegatedFunction("Tan", self.__tan_functional_calculator, self))
        self.add(DelegatedFunction("Sqr", self.__sqrt_functional_calculator, self))
        self.add(DelegatedFunction("Sqrt", self.__sqrt_functional_calculator, self))
        self.add(DelegatedFunction("Empty", self.__empty_functional_calculator, self))
        self.add(DelegatedFunction("Null", self.__null_functional_calculator, self))
        self.add(DelegatedFunction("Contains", self.__contains_functional_calculator, self))
        self.add(DelegatedFunction("Array", self.__array_functional_calculator, self))
