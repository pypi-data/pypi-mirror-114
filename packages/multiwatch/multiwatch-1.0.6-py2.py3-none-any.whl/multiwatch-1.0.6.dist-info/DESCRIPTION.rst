...
The `source code <http://source.pelicandd.com/codebase/multiwatch>`_ is available. The package is distributed under `MIT License <https://opensource.org/licenses/MIT>`_.
