...
def naive_bayes():
    ...
    from psox.models.bayes import touchstone
    touchstone(X_train, y_train, X_test, y_test)


def lstm():
    from psox.keras.preprocess import label_encode, tokenize
    ...
    from psox.keras.preprocess import pad_sequences
    ...
    from psox.models.nn import lstm_touchstone
