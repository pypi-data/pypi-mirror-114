...
import numpy as np,datetime as dt,pytz,pandas as pd
...
class ConfigAristote():
    def __init__(self):
        ...
        self.geolocator = Nominatim(user_agent="Dorian")
...
# ==============================================================================
    ...
    def azimut(self,declinaison, hauteurAngulaire, latituderad, angleHoraire):
