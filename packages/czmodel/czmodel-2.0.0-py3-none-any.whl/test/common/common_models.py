...
if TYPE_CHECKING:
    from tensorflow.keras.models import Model  # pylint: disable=no-name-in-module # Caused by TensorFlow

# pylint: disable=import-outside-toplevel


def setup_keras_model_functional(
    ...
    """
    from tensorflow.keras.layers import (  # pylint: disable=no-name-in-module # Caused by TensorFlow
        Conv2D,
        Input
    )
    from tensorflow.keras.models import Model  # pylint: disable=no-name-in-module # Caused by TensorFlow
