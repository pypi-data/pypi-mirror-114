...
from detection_tools.utils import metrics
from detection_tools.utils import detection_tools_evaluation
from detection_tools.utils import per_image_vrd_evaluation
...
class VRDDetectionEvaluator(detection_tools_evaluation.DetectionEvaluator):
