...
# ==============================================================================
"""detection_tools_evaluation module.
...
from detection_tools.utils import label_map_util
from detection_tools.utils import metrics
from detection_tools.utils import per_image_evaluation
...
class ObjectDetectionEvaluation(object):
  ...
  def add_single_detected_image_info(self,
    ...
    scores, tp_fp_labels, is_class_correctly_detected_in_image = (
        self.per_image_eval.compute_detection_tools_metrics(
            detected_boxes=detected_boxes,
            detected_scores=detected_scores,
