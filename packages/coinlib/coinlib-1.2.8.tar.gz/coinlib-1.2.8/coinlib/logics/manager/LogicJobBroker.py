...
class LogicJobBroker:
    ...
    def sellAll(self):
        ...
        self.manager.saveInfo("trader", "sellAll", {"amount": 100})
    ...
    def buy(self, symbol, amount=None, amountQuote=None, price=None, leverage=None, group=None):

        self.manager.saveInfo("trader", "buy", {"symbol": symbol, "amount": amount, "amountQuote": amountQuote, "price": price, "group": group})

        return False

    def sell(self, symbol, amount=None, amountQuote=None, price=None, leverage=None, group=None):
        self.manager.saveInfo("trader", "sell", {"symbol": symbol, "amountQuote": amountQuote, "amount": amount, "price": price, "group": group})
        return False
    ...
    def long(self, symbol: BrokerSymbol, amount: float = None, amountQuote=None,  price=None, leverage=None, group=None):
        self.manager.saveInfo("trader", "long", {"amount": amount, "amountQuote": amountQuote,  "price": price, "group": group})
        return True

    def short(self, symbol: BrokerSymbol, amount: float= None, amountQuote=None, price=None, leverage=None, group=None):
        self.manager.saveInfo("trader", "short", {"amount": amount, "amountQuote": amountQuote,  "price": price, "group": group})
        return True
    ...
    def closeAllPositions(self):
        self.manager.saveInfo("trader", "closeAllPositions", {})
        return False
