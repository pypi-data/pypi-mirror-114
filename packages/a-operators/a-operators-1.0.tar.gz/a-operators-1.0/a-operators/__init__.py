...
def get_provider_info():
    return {
        ...
        "extra-links": [
                         "novigi_operators.operators.CustomCSVToS3Operator",
                         "novigi_operators.operators.NovigiCSVToDatabaseExportOperator",
                         "novigi_operators.operators.NovigiExcelToCSVExportOperator",
                         "novigi_operators.operators.NovigiJsonToCSVExportOperator",
                         "novigi_operators.operators.NovigiXlsToCSVOperator"
                       ],
