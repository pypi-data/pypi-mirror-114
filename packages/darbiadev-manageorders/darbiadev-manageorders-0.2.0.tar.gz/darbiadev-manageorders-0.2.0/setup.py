...
packages = \
['darbiadev_manageorders', 'darbiadev_manageorders.lib']
...
setup_kwargs = {
    'name': 'darbiadev-manageorders',
    'version': '0.2.0',
    'description': 'darbiadev-manageorders',
    'long_description': '# darbiadev-manageorders\n',
    'author': 'Bradley Reynolds',
    'author_email': 'bradley.reynolds@darbia.dev',
    'maintainer': None,
    'maintainer_email': None,
    'url': 'https://github.com/DarbiaDev/darbiadev-manageorders',
    'packages': packages,
