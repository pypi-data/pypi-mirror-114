...
class specificationProblem(vns.problemClass):
    ...
    def __init__(
        ...
        solutionClass) and the values are the estimation results
        (objects of type biogeme.results.bioResults).
        """
        ...
        :meth:`biogeme.assisted.specificationProblem.__init__`
        """
        ...
        alternatives, and the values are objects of type ``utility``
        """
        ...
        """ See :meth:`biogeme.vns.operatorsManagement`
        """
