...
class BIOGEME:
    ...
    def __init__(
        ...
        :type database: :meth:`biogeme.database.Database`
        ...
        :type formulas: :meth:`biogeme.expressions.Expression`, or
                        dict(:meth:`biogeme.expressions.Expression`)
        ...
        if not isinstance(formulas, dict):
            ...
            """ Object of type :meth:`biogeme.expressions.Expression`
            ...
            :meth:`biogeme.expressions.Expression`.
        ...
        self.database = database #: :meth:`biogeme.database.Database` object
    ...
    def calculateNullLoglikelihood(self, avail):
        ...
        :type avail: list of :meth:`biogeme.expressions.Expression`
