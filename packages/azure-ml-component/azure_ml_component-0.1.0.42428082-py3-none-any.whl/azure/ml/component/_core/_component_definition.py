...
class PipelineComponentDefinition(ComponentDefinition):
    ...
    def get_registered_pipeline_graph(self):
        ...
        if self.identifier:
            ...
            return self.api_caller.imp.service_caller._get_pipeline_component_graph(graph_id=graph_id)
        else:
            return None
    ...
    def generate_interface(self):
        ...
        for param_name, param in self._flatten_pipeline_parameters(self._pipeline_parameters).items():
            ...
            if len(param.linked_params) + len(param.linked_param_assignments) == 0:
                logging.warning(
