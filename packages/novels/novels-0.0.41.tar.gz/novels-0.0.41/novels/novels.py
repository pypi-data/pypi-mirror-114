...
def adhoc_fetch(title,page,limit=10,tgtdir=os.getcwd(),debug=False,force=0) :
    ...
    with open(cfgfile,"r",encoding="UTF-8") as f :
        ...
        for ln in f.readlines() :
            ...
            if m :
                ...
                try :
                    rpt = adhoc_fetch(title,page,num,tgtdir,debug,force) + "\n\n"
                    report += rpt
...
def novels_main():
    ...
    if args.title :
        adhoc_fetch(args.title,args.page,args.number,args.dir,args.debug,args.force)
        return
