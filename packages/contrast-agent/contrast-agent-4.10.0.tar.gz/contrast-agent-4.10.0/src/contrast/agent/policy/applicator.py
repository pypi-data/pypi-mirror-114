...
def apply_patch_to_dynamic_property(class_to_patch, property_name, tags):
    ...
    NOTE: adding the dynamic source to Policy() BEFORE calling patch_cls_or_instance
    ...
    patch_cls_or_instance(
        class_to_patch, property_name, assess_property, patch_policy, property_fset=fset
    )
