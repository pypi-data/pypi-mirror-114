...
from contrast.agent.assess.policy.patches import assess_method
...
def build_codec_patch(module, method_name):
    ...
    def codec_patch(self, *args, **kwargs):
        return assess_method(orig_method, patch_policy, self, *args, **kwargs)
