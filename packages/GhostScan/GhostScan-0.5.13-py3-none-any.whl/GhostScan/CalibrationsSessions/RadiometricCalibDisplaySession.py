...
class RadiometricCalibDisplaySession(CalibrationSession, ABC):
    ...
    def calculateDisplayCalibration(self):
        ...
        for pixelValue in pixelValues:
            num = math.exp(self.g[(pixelValue)] - math.log(self.exposure))
    ...
    def calculateReflectivity(self):
        imgPath = 'testImages/RadioDisplayTest.png'
        ...
        print('Reflectivity Calculation Successful! Plot and reconstruction image viewable at CapturedImages/sequenceImages/undistortRadioCalib/radioCalibResults')
