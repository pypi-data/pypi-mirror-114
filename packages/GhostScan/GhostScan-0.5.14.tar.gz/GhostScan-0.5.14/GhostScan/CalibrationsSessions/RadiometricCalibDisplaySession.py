...
class RadiometricCalibDisplaySession(CalibrationSession, ABC):
    def __init__(self, camera, radio_calib, path='CalibrationImages/DisplayRadiometric', exposure=13000, numPhaseShift = 4):
        ...
        if not os.path.exists('CapturedImages/sequenceImages/undistortRadioCalib/undistortResults/'):
            os.mkdir('CapturedImages/sequenceImages/undistortRadioCalib/radioCalibResults/undistortResults/')
    ...
    def calculateReflectivity(self):
        ...
        print('Reflectivity Calculation Successful! Plot and reconstruction image viewable at CapturedImages/sequenceImages/undistortRadioCalib/undistortResults')
