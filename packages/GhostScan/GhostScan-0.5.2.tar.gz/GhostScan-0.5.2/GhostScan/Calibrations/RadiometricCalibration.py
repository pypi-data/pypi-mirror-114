...
class RadiometricCalibration:
    ...
    def plotCurve(self, title):
        ...
        if not os.path.exists('CapturedImages/sequencesImages/undistortRadioCalib/'):
            os.mkdir('CapturedImages/sequencesImages/undistortRadioCalib/')
        if not os.path.exists('CapturedImages/sequencesImages/undistortRadioCalib/radioCalibResults/'):
            os.mkdir('CapturedImages/sequencesImages/undistortRadioCalib/radioCalibReslts/')
