...
def load_plugins(plugin_name):
    if plugin_name.startswith("__"):
        ...
        from . import HNDLR, LOGS, asst, udB, OrangIT_bot
        ...
        from .misc._decorators import OrangIT_cmd
        ...
        mod.asst = asst
        mod.tgbot = asst
        mod.OrangIT_bot = OrangIT_bot
        mod.bot = OrangIT_bot
        mod.OrangIT = OrangIT_bot
        mod.owner = owner()
        ...
        mod.OrangIT_cmd = OrangIT_cmd
        mod.on_cmd = OrangIT_cmd
...
def load_addons(plugin_name):
    if plugin_name.startswith("__"):
        ...
        mod.bot = OrangIT_bot
        mod.OrangIT = OrangIT_bot
        mod.borg = OrangIT_bot
        mod.telebot = OrangIT_bot
        mod.jarvis = OrangIT_bot
        mod.friday = OrangIT_bot
        mod.owner = owner()
        mod.in_owner = inline_owner()
        mod.inline = inline()
        mod.eod = eod
...
def load_assistant(plugin_name):
    if plugin_name.startswith("__"):
        ...
        from . import HNDLR, asst, udB, OrangIT_bot
...
def load_manager(plugin_name):
    if plugin_name.startswith("__"):
        ...
        from . import asst, udB, OrangIT_bot
        from .misc._assistant import asst_cmd, callback, owner
...
def load_vc(plugin_name):
    if plugin_name.startswith("__"):
        ...
        from . import CallsClient, udB, OrangIT_bot, vcasst, vcClient
