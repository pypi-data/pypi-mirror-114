...
# <https://www.github.com/Projectgeez/OrangIT/blob/main/LICENSE/>.
#
...
from pyorit.misc._decorators import *
from pyorit.misc._wrappers import eod, eor

from .. import udB, OrangIT_bot
from ..dB.core import LIST
from ..dB.database import Var

ALIVE_NAME = OrangIT_bot.me.first_name
...
#   OrangIT Don't Need This Configs
...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "OrangIT")
