...
@qparam(
    ...
    description="An array of JSON objects to specify the search within the extra"
...
def get_records(page, per_page, qparams):
    ...
    of some of the query parameters.
    """
    collection_ids = []
    ...
    if qparams["collection"]:
        ...
        collection_ids = [collection.id for collection in collection_ids_query]
