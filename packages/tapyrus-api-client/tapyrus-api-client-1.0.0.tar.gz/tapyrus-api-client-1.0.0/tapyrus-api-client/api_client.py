...
from tapyrus-api-client import rest
from tapyrus-api-client.configuration import Configuration
from tapyrus-api-client.exceptions import ApiTypeError, ApiValueError, ApiException
from tapyrus-api-client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_address  # this is an instance of the class Endpoint
        api_instance.create_address()  # this invokes api_instance.create_address.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_address.callable or self.callable in this class
