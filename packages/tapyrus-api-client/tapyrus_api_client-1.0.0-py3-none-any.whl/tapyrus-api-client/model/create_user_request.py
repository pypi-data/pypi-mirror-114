...
class CreateUserRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id_token, issuer, client_id, access_token, *args, **kwargs):  # noqa: E501
        """CreateUserRequest - a model defined in OpenAPI

        Args:
            id_token (str): [Token Endpoint](http://openid-foundation-japan.github.io/openid-connect-core-1_0.ja.html#TokenEndpoint) の応答に含まれる id_token
            issuer (str): [OpenID Provider Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata) における issuer
            client_id (str): [OAuth 2.0 Client Credential](https://datatracker.ietf.org/doc/html/rfc6749#section-2.3.1) における client_id
            access_token (str): [Token Endpoint](http://openid-foundation-japan.github.io/openid-connect-core-1_0.ja.html#TokenEndpoint) の応答に含まれる access_token
    ...
    @convert_js_args_to_python_args
    def __init__(self, id_token, issuer, client_id, access_token, *args, **kwargs):  # noqa: E501
        """CreateUserRequest - a model defined in OpenAPI
