...
class SlappResponseObject:
    ...
    def get_teams_for_player(self, p: Player) -> List[Team]:
        ...
        return list(map(lambda t: self.known_teams.get(t, UnknownTeam) if t != NoTeam.guid else NoTeam, p.teams))
    ...
    def placement_is_winning_low_ink(placement: Tuple[int, str, str]):
        return placement and placement[0] == 1 and (placement[1].startswith("Top Cut") or placement[1].startswith("Alpha"))
