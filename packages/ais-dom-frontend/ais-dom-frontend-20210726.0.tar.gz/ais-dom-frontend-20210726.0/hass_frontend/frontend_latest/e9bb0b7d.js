...
`,is:"paper-item",behaviors:[n.U]})},51095:(e,t,i)=>{"use strict";i(65233);var a=i(78161),o=i(9672),n=i(50856);(0,o.k)({_template:n.d`
    ...
    <slot></slot>
`,is:"paper-listbox",behaviors:[a.i],hostAttributes:{role:"listbox"}})},77190:(e,t,i)=>{"use strict";i(85408);var a=i(50856);const o=a.d`<dom-module id="material-date-picker-overlay" theme-for="vaadin-date-picker-overlay">
  <template>
...
</dom-module>`;document.head.appendChild(o.content);var n=i(1335),s=i(16777);class r extends((0,s.f)(n.G)){static get is(){return"vaadin-date-picker-overlay"}}customElements.define(r.is,r);i(85466),i(37365);const l=a.d`<dom-module id="material-button" theme-for="vaadin-button">
  <template>
    <style>
      :host {
        padding: 8px;
...
</dom-module>`;document.head.appendChild(l.content);var d=i(28426),h=i(60995),c=i(4358);let u=!1;window.addEventListener("keydown",(()=>{u=!0}),{capture:!0}),window.addEventListener("mousedown",(()=>{u=!1}),{capture:!0});const p=e=>class extends((e=>class extends e{static get properties(){var e={tabindex:{type:Number,value:0,reflectToAttribute:!0,observer:"_tabindexChanged"}};return window.ShadyDOM&&(e.tabIndex=e.tabindex),e}})(e)){static get properties(){return{autofocus:{type:Boolean},_previousTabIndex:{type:Number},disabled:{type:Boolean,observer:"_disabledChanged",reflectToAttribute:!0},_isShiftTabbing:{type:Boolean}}}ready(){this.addEventListener("focusin",(e=>{e.composedPath()[0]===this?this.contains(e.relatedTarget)||this._focus():-1===e.composedPath().indexOf(this.focusElement)||this.disabled||this._setFocused(!0)})),this.addEventListener("focusout",(e=>this._setFocused(!1))),super.ready();const e=e=>{e.composed||e.target.dispatchEvent(new CustomEvent(e.type,{bubbles:!0,composed:!0,cancelable:!1}))};this.shadowRoot.addEventListener("focusin",e),this.shadowRoot.addEventListener("focusout",e),this.addEventListener("keydown",(e=>{if(!e.defaultPrevented&&9===e.keyCode)if(e.shiftKey)this._isShiftTabbing=!0,HTMLElement.prototype.focus.apply(this),this._setFocused(!1),setTimeout((()=>this._isShiftTabbing=!1),0);else{const e=window.navigator.userAgent.match(/Firefox\/(\d\d\.\d)/);if(e&&parseFloat(e[1])>=63&&parseFloat(e[1])<66&&this.parentNode&&this.nextSibling){const e=document.createElement("input");e.style.position="absolute",e.style.opacity="0",e.tabIndex=this.tabIndex,this.parentNode.insertBefore(e,this.nextSibling),e.focus(),e.addEventListener("focusout",(()=>this.parentNode.removeChild(e)))}}})),this.autofocus&&!this.disabled&&window.requestAnimationFrame((()=>{this._focus(),this._setFocused(!0),this.setAttribute("focus-ring","")}))}disconnectedCallback(){super.disconnectedCallback(),this.hasAttribute("focused")&&this._setFocused(!1)}_setFocused(e){e?this.setAttribute("focused",""):this.removeAttribute("focused"),e&&u?this.setAttribute("focus-ring",""):this.removeAttribute("focus-ring")}get focusElement(){return window.console.warn(`Please implement the 'focusElement' property in <${this.localName}>`),this}_focus(){this.focusElement&&!this._isShiftTabbing&&(this.focusElement.focus(),this._setFocused(!0))}focus(){this.focusElement&&!this.disabled&&(this.focusElement.focus(),this._setFocused(!0))}blur(){this.focusElement&&(this.focusElement.blur(),this._setFocused(!1))}_disabledChanged(e){this.focusElement.disabled=e,e?(this.blur(),this._previousTabIndex=this.tabindex,this.tabindex=-1,this.setAttribute("aria-disabled","true")):(void 0!==this._previousTabIndex&&(this.tabindex=this._previousTabIndex),this.removeAttribute("aria-disabled"))}_tabindexChanged(e){void 0!==e&&(this.focusElement.tabIndex=e),this.disabled&&this.tabindex&&(-1!==this.tabindex&&(this._previousTabIndex=this.tabindex),this.tabindex=e=void 0),window.ShadyDOM&&this.setProperties({tabIndex:e,tabindex:e})}click(){this.disabled||super.click()}};var m=i(21683),_=i(78956),f=i(93252),v=i(59898);const g=/\/\*\*\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,b=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;function y(e,t){if("function"!=typeof e)return;const i=g.exec(e.toString());if(i)try{e=new Function(i[1])}catch(e){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",e)}return e(t)}window.Vaadin=window.Vaadin||{};const w=function(e,t){if(window.Vaadin.developmentMode)return y(e,t)};function D(){}void 0===window.Vaadin.developmentMode&&(window.Vaadin.developmentMode=function(){try{return!!localStorage.getItem("vaadin.developmentmode.force")||["localhost","127.0.0.1"].indexOf(window.location.hostname)>=0&&(b?!(b&&Object.keys(b).map((e=>b[e])).filter((e=>e.productionMode)).length>0):!y((function(){return!0})))}catch(e){return!1}}());const x=function(){return w(D)};let k;window.Vaadin||(window.Vaadin={}),window.Vaadin.registrations=window.Vaadin.registrations||[],window.Vaadin.developmentModeCallback=window.Vaadin.developmentModeCallback||{},window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]=function(){x&&x()};const S=new Set,C=e=>class extends((0,v.U)(e)){static finalize(){super.finalize();const{is:e}=this;e&&!S.has(e)&&(window.Vaadin.registrations.push(this),S.add(e),window.Vaadin.developmentModeCallback&&(k=_.dx.debounce(k,m.t$,(()=>{window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]()})),(0,f.E)(k)))}constructor(){super(),null===document.doctype&&console.warn('Vaadin components require the "standards mode" declaration. Please add <!DOCTYPE html> to the HTML document.')}};var E=i(81668);class M extends(C(p((0,c.T)((0,h._)(d.H3))))){static get template(){return a.d`
    <style>
      :host {
...
`}static get is(){return"vaadin-button"}static get version(){return"2.4.0"}ready(){super.ready(),this.setAttribute("role","button"),this.$.button.setAttribute("role","presentation"),this._addActiveListeners(),window.ShadyDOM&&window.ShadyDOM.flush()}disconnectedCallback(){super.disconnectedCallback(),this.hasAttribute("active")&&this.removeAttribute("active")}_addActiveListeners(){(0,E.NH)(this,"down",(()=>!this.disabled&&this.setAttribute("active",""))),(0,E.NH)(this,"up",(()=>this.removeAttribute("active"))),this.addEventListener("keydown",(e=>!this.disabled&&[13,32].indexOf(e.keyCode)>=0&&this.setAttribute("active",""))),this.addEventListener("keyup",(()=>this.removeAttribute("active"))),this.addEventListener("blur",(()=>this.removeAttribute("active")))}get focusElement(){return this.$.button}}customElements.define(M.is,M);const A=a.d`<dom-module id="material-date-picker-overlay-content" theme-for="vaadin-date-picker-overlay-content">
  <template>
    <style>
      :host {
        font-family: var(--material-font-family);
...
`}static get is(){return"vaadin-date-picker-light"}static get properties(){return{attrForValue:{type:String,value:"bind-value"},_overlayInitialized:{type:Boolean,value:!0}}}_input(){return this.querySelector("vaadin-text-field,iron-input,paper-input,.paper-input-input,.input")}set _inputValue(e){this._inputElement&&(this._inputElement[(0,N.z)(this.attrForValue)]=e)}get _inputValue(){return this._inputElement&&this._inputElement[(0,N.z)(this.attrForValue)]}}customElements.define(q.is,q)}}]);
//# sourceMappingURL=e9bb0b7d.js.map