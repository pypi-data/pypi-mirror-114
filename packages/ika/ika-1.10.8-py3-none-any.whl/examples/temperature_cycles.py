...
# file logging set up
LogFilePath = Path(fr'{datetime.now().strftime(f"temperature cycles log - %Y-%m-%d %H-%M")}.log')
...
if __name__ == '__main__':
    ...
    wait_until_probe_temperature_stable_time_minutes = 90
    ...
    file_path = Path('temperature cycle experiment')
