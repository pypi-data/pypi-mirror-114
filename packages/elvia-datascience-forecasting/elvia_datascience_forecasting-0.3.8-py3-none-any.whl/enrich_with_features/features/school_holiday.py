...
def school_holiday(df: pd.DataFrame, path_holiday: str = '') -> pd.DataFrame:
    '''
    ...
    # Returns:
    --------------
    pandas.DataFrame: Dataframe with the school_holiday and substation ID variables
    '''
    ...
    df['school_holiday'] = pd.Series(dtype='boolean')
