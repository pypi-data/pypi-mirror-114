...
def head_view(
    ...
    # html2pdf_js = open(os.path.join(__location__, 'html2pdf.bundle.min.js')).read()
    # display(Javascript(html2pdf_js))
    # require.js must be imported for Colab or JupyterLab:
    # display(HTML(f'<script src="https://raw.githubusercontent.com/eKoopmans/html2pdf.js/master/dist/html2pdf.bundle.min.js"></script>'))
    # display(HTML('<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.3.1/jspdf.umd.min.js"></script>'))
