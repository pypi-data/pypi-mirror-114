...
class RawModuleManager(
    ...
    def download(self, module):
        ...
        if status:
            result["settings.json"] = SettingsParser(result)
...
class ModuleManager(
    ...
    def gen_link(self, module):
        self.linkers[module] = importlib.import_module("." + module, "RashSetup.__RashModules__")

    def parse_link(self, module):
        module = self.linkers[module]
        print(dir(module))

    def investigate(self, module):
        print(super().download(module))
