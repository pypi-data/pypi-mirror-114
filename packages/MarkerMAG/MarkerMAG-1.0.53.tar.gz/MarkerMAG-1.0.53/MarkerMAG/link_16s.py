...
if __name__ == '__main__':
    ...
    link_16s_parser_16s.add_argument('-min_iden_16s',       required=False, metavar='', type=float, default=99,             help='minimum similarity for 16S sequences to be assigned to the same genome, (default: %(default)s)')
    ...
    link_16s_parser_rd2.add_argument('-mira_tmp',           required=False, metavar='',             default=None,           help='tmp dir for mira')
