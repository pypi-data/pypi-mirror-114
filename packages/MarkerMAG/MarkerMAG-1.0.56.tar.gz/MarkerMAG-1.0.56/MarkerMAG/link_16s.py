...
def link_16s(args):
    ...
    min_iden_16s                        = args['min_16s_iden']
...
if __name__ == '__main__':
    ...
    link_16s_parser_16s.add_argument('-min_16s_len',        required=False, metavar='', type=int,   default=1200,           help='minimum length of 16S (in bp) for linking, (default: %(default)s)')
    link_16s_parser_16s.add_argument('-skip_16s_qc',        required=False, action="store_true",                            help='skip quality control of input 16S, not recommended')
    link_16s_parser_16s.add_argument('-min_16s_iden',       required=False, metavar='', type=float, default=99,             help='minimum similarity between 16S assigned to the same genome, (default: %(default)s)')
    ...
    link_16s_parser_linking.add_argument('-aln_len',        required=False, metavar='', type=int,   default=45,             help='minimum read alignment length, (default: %(default)s)')
    ...
    link_16s_parser_linking.add_argument('-min_link',       required=False, metavar='', type=int,   default=8,              help='minimum number of linkages to report, (default: %(default)s)')
