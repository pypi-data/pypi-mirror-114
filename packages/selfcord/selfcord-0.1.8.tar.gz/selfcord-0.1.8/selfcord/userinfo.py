...
class UserInfo:
    ...
    def getUsername(id):
        ...
        Logger.log(f"Returned fetched username from '{id}'.")
    ...
    def getId(id):
        ...
        Logger.log(f"Returned fetched id from '{id}'.")
    ...
    def getAvatar(id):
        ...
        Logger.log(f"Returned fetched avatar from '{id}'.")
    ...
    def getBanner(id):
        ...
        Logger.log(f"Returned fetched banner from '{id}'.")
    ...
    def getDiscriminator(id):
        ...
        Logger.log(f"Returned fetched discriminator from '{id}'.")
    ...
    def getPublicFlags(id):
        ...
        Logger.log(f"Returned fetched public flags from '{id}'.")
    ...
    def isBot(id):
        ...
        Logger.log(f"Returned fetched bot from '{id}'.")
