...
def main(action: str = "login", phone_number: str = "", folder_conf: str = ".") -> None:
    ...
    try:
        ...
        if not phone_number:
            raise
    folder: str = args.folder or folder_conf  # type: ignore
    phone: str = normalize_phone_number(args.number or phone_number)  # type: ignore
    ...
    command = args.command or action  # type: ignore
