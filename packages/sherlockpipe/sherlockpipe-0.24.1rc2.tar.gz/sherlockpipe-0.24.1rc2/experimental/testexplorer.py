...
with elapsed_timer() as elapsed:
    ...
    sherlock.explore_object("TIC 426017070", auto_detrend_periodic_signals=False, smooth=True, cadence=120,
                            input_lc_file="../../tkmatrix/tkmatrix/TIC441713413_ir/P4.26530612244898_R1.98_1740.132922023477.csv")
