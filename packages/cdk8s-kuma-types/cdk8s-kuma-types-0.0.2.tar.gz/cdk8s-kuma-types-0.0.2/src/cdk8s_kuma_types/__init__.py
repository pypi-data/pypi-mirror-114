...
class CircuitBreaker(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = CircuitBreakerProps(mesh=mesh, spec=spec)

        jsii.create(CircuitBreaker, self, [scope, id, props])
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"mesh": "mesh", "spec": "spec"},
)
...
class Dataplane(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = DataplaneProps(mesh=mesh, spec=spec)

        jsii.create(Dataplane, self, [scope, id, props])
...
class DataplaneInsight(
    ...
    def __init__(
        ...
        *,
        ...
        :param mesh: 
        '''
        props = DataplaneInsightProps(mesh=mesh)

        jsii.create(DataplaneInsight, self, [scope, id, props])

    @jsii.member(jsii_name="manifest") # type: ignore[misc]
    @builtins.classmethod
    def manifest(cls, *, mesh: typing.Optional[builtins.str] = None) -> typing.Any:
...
class ExternalService(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = ExternalServiceProps(mesh=mesh, spec=spec)

        jsii.create(ExternalService, self, [scope, id, props])
...
class FaultInjection(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = FaultInjectionProps(mesh=mesh, spec=spec)

        jsii.create(FaultInjection, self, [scope, id, props])
...
class HealthCheck(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = HealthCheckProps(mesh=mesh, spec=spec)

        jsii.create(HealthCheck, self, [scope, id, props])
...
class MeshInsight(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = MeshInsightProps(mesh=mesh, spec=spec)

        jsii.create(MeshInsight, self, [scope, id, props])
...
class ProxyTemplate(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = ProxyTemplateProps(mesh=mesh, spec=spec)

        jsii.create(ProxyTemplate, self, [scope, id, props])
...
class RateLimit(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = RateLimitProps(mesh=mesh, spec=spec)

        jsii.create(RateLimit, self, [scope, id, props])
...
class Retry(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = RetryProps(mesh=mesh, spec=spec)

        jsii.create(Retry, self, [scope, id, props])
...
class ServiceInsight(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = ServiceInsightProps(mesh=mesh, spec=spec)

        jsii.create(ServiceInsight, self, [scope, id, props])
...
class Timeout(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = TimeoutProps(mesh=mesh, spec=spec)

        jsii.create(Timeout, self, [scope, id, props])
...
class TrafficLog(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = TrafficLogProps(mesh=mesh, spec=spec)

        jsii.create(TrafficLog, self, [scope, id, props])
...
class TrafficPermission(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = TrafficPermissionProps(mesh=mesh, spec=spec)

        jsii.create(TrafficPermission, self, [scope, id, props])
...
class TrafficRoute(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = TrafficRouteProps(mesh=mesh, spec=spec)

        jsii.create(TrafficRoute, self, [scope, id, props])
...
class TrafficTrace(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = TrafficTraceProps(mesh=mesh, spec=spec)

        jsii.create(TrafficTrace, self, [scope, id, props])
...
class Zone(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = ZoneProps(mesh=mesh, spec=spec)

        jsii.create(Zone, self, [scope, id, props])
...
class ZoneIngress(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = ZoneIngressProps(mesh=mesh, spec=spec)

        jsii.create(ZoneIngress, self, [scope, id, props])
...
class ZoneIngressInsight(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = ZoneIngressInsightProps(mesh=mesh, spec=spec)

        jsii.create(ZoneIngressInsight, self, [scope, id, props])
...
class ZoneInsight(
    ...
    def __init__(
        ...
        *,
        ...
        :param spec: 
        '''
        props = ZoneInsightProps(mesh=mesh, spec=spec)

        jsii.create(ZoneInsight, self, [scope, id, props])
