...
class RegistriesRegistryConfigurePayload(object):
    ...
    def __init__(self, authentication=None, password=None, tls=None, tlscacert_file=None, tlscert_file=None, tlskey_file=None, tlsskip_verify=None, username=None, _configuration=None):  # noqa: E501
