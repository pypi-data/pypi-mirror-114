...
class EndpointGroupsApi(object):
    ...
    def endpoint_group_delete_endpoint(self, id, endpoint_id, **kwargs):  # noqa: E501
        """Removes endpoint from an endpoint group  # noqa: E501
    ...
    def endpoint_groups_post(self, body, **kwargs):  # noqa: E501
        """Create an Endpoint Group  # noqa: E501
        ...
        :param async_req bool
        :param EndpointgroupsEndpointGroupCreatePayload body: Endpoint Group details (required)
        :return: PortainerEndpointGroup
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def endpoint_groupsid_get(self, id, **kwargs):  # noqa: E501
        """Inspect an Endpoint group  # noqa: E501

        Retrieve details abont an endpoint group. **Access policy**: administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.endpoint_groupsid_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.endpoint_groupsid_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.endpoint_groupsid_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def endpoint_groupsid_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Inspect an Endpoint group  # noqa: E501

        Retrieve details abont an endpoint group. **Access policy**: administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.endpoint_groupsid_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method endpoint_groupsid_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `endpoint_groupsid_get`")  # noqa: E501
