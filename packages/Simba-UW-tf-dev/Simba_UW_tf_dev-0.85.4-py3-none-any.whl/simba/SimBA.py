...
class droptrackingdata:
    def __init__(self):
        ...
        self.fFolder = FolderSelect(dtLabelframe, 'Data Folder', lblwidth='10')
        self.poseTool = DropDownMenu(dtLabelframe, 'Tracking tool', ['DLC','maDLC'], '10')
        self.poseTool.setChoices('DLC')
        self.fileFormat = DropDownMenu(dtLabelframe, 'File Type', ['csv', 'h5'], '10')
        self.fileFormat.setChoices('csv')
        self.noofbp = Entry_Box(dtLabelframe,'# of Bp','8')
