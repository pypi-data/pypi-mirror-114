...
(function () {
    ...
    Fields.BaseFieldView = Backbone.View.extend({
         ...
         */
        _loadValue: function _loadValue(options) {
            var fieldName = this.useExtraData ? this.jsonFieldName : _.result(this, 'fieldName');
    ...
    Fields.TextFieldView = Fields.BaseFieldView.extend({
        ...
        render: function render() {
            ...
            this.listenTo(this.inlineEditorView, 'resize', function () {
            ...
            this.listenTo(this.inlineEditorView, 'complete', function (value) {
                ...
                if (_this.allowRichText) {
                    ...
                    saveOptions.jsonTextTypeFieldName = _this.jsonTextTypeFieldName;
                }
         ...
         */
        _loadRichTextValue: function _loadRichTextValue() {
            if (this.useExtraData) {
                var textTypeFieldName = this.jsonTextTypeFieldName;
                var textType = this.model.getDraftField(textTypeFieldName, {
                    useExtraData: true,
                    useRawTextValue: true
                });
            ...
            this.inlineEditorView.$field.datepicker({
                ...
                onSelect: function onSelect(dateText, instance) {
                    if (dateText !== instance.lastVal) {
                        _this5.inlineEditorView._dirty = true;
                    }
                }
            });
