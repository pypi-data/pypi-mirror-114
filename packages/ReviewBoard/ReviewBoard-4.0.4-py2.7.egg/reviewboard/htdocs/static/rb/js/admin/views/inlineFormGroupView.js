...
RB.Admin.InlineFormGroupView = Backbone.View.extend({
    ...
    render: function render() {
         ...
         */
        var $initialForms = $inlines.children('#id_' + prefix + '-INITIAL_FORMS');
        var $maxNumForms = $inlines.children('#id_' + prefix + '-MAX_NUM_FORMS');
        var $minNumForms = $inlines.children('#id_' + prefix + '-MIN_NUM_FORMS');
        var $totalForms = $inlines.children('#id_' + prefix + '-TOTAL_FORMS');
