...
RB.ReviewRequestPage.IssueSummaryTableView = Backbone.View.extend({
    ...
    _onIssueStatusChanged: function _onIssueStatusChanged(comment, oldStatus, timestamp) {
        ...
        var $oldCounter = this._$tabs.children('[data-issue-state=' + oldStatus + ']').find('.rb-c-issue-summary-table__counter');
        var $newCounter = this._$tabs.children('[data-issue-state=' + newStatus + ']').find('.rb-c-issue-summary-table__counter');
