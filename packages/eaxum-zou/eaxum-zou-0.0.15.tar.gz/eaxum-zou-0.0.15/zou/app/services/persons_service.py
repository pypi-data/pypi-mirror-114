...
# from zou.app.services import genesis_service, ldap_service
...
def create_person(
    ...
    #TODO create ldap user
    # if config.ENABLE_GENESIS:
    #     desktop_login=ldap_service.create_ldap_user(first_name, last_name, email, password='default')
    #     print(desktop_login, '----create ldap user-----------')
