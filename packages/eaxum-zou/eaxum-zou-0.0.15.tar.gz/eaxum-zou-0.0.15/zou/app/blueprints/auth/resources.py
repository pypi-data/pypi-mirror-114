...
from zou.app import app, mail, config
from zou.app.mixin import ArgsMixin
from zou.app.utils import auth
from zou.app.services import genesis_service, persons_service, auth_service, events_service #ldap_service
...
class AuthenticatedResource(Resource):
    ...
    def get(self):
        try:
            ...
            #TODO create use with ldap
            # if app.config['ENABLE_GENESIS']:
            #     return {
            #     "authenticated": True,
            #     "user": person,
...
class ChangePasswordResource(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            auth.validate_password(password, password_2)
            #TODO reset ladp password
            # if app.config['ENABLE_GENESIS']:
            #     user_name = user_name = f"uid={persons_service.get_current_user()['desktop_login']},{config.LDAP_BASE_DN}"
            #     ldap_service.update_ldap_user_password(user_name, password)
            password = auth.encrypt_password(password)
    ...
    def put(self):
        ...
        try:
            ...
            if email:
                ...
                #TODO reset ladp password
                # if app.config['ENABLE_GENESIS']:
                #     ldap_service.update_ldap_user_password()
