...
class MessageProcessor:
    ...
    async def _handle_message_with_tracker(
        ...
        if parse_data['text']:
            parse_data['text'] = self.convert_pci_message(parse_data['text'])
        ...
        if should_redact:
            ...
            if parse_data['text']:
                parse_data['text'] = UserUttered.redact_msg(parse_data['text'])
