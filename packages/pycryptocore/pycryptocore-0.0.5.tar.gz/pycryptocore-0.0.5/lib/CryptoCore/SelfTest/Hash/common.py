# -*- coding: utf-8 -*-
#
#  SelfTest/Hash/common.py: Common code for CryptoCore.SelfTest.Hash
#
...
"""Self-testing for PyCryptoCore hash modules"""
...
from CryptoCore.Util.py3compat import b, tobytes
...
class HashSelfTest(unittest.TestCase):
    ...
    def runTest(self):
        ...
        if self.hashmod.__name__ not in ('CryptoCore.Hash.MD5', 'CryptoCore.Hash.SHA1') or hasattr(h, 'new'):
            h2 = h.new()
