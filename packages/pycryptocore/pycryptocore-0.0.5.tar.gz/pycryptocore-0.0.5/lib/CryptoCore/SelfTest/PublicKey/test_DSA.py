...
"""Self-test suite for CryptoCore.PublicKey.DSA"""
...
class DSATest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from CryptoCore.PublicKey import DSA
        from CryptoCore import Random
        from CryptoCore.Util.number import bytes_to_long, inverse, size
...
class DSADomainTest(unittest.TestCase):
    ...
    def _get_weak_domain(self):
        ...
        from CryptoCore.Math import Primality
