# -*- coding: utf-8 -*-
#
#  SelfTest/Util/test_number.py: Self-test for parts of the CryptoCore.Util.number module
#
...
"""Self-tests for (some of) CryptoCore.Util.number"""

import math
import unittest

from CryptoCore.Util.py3compat import *
from CryptoCore.SelfTest.st_common import list_test_cases

from CryptoCore.Util import number
...
class MiscTests(unittest.TestCase):
    ...
    def test_isPrime(self):
        ...
        self.assertEqual(number.isPrime(1), False)      # Regression test: isPrime(1) caused some versions of PyCryptoCore to crash.
