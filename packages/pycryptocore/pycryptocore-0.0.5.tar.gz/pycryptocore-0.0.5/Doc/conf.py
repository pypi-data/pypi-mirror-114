# -*- coding: utf-8 -*-
#
# PyCryptoCore documentation build configuration file, created by
...
from CryptoCore.Util import _raw_api
...
_raw_api.load_pycryptocore_raw_lib = lambda name, cdec: MockLib()
...
for line in open(os.path.join("..", "lib", "CryptoCore", "__init__.py")):
...
htmlhelp_basename = 'PyCryptoCoredoc'
...
latex_documents = [
  ('index', 'PyCryptoCore.tex', u'PyCryptoCore Documentation',
   u'Legrandin', 'manual'),
]
...
man_pages = [
    ('index', 'pycryptocore', u'PyCryptoCore Documentation',
     [u'Legrandin'], 1)
]
...
texinfo_documents = [
  ('index', 'PyCryptoCore', u'PyCryptoCore Documentation',
   u'Legrandin', 'PyCryptoCore', 'One line description of project.',
   'Miscellaneous'),
]
