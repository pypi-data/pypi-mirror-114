:mod:`CryptoCore.Hash` package
==========================

CryptoCoregraphic hash functions take arbitrary binary strings as input,
...
:func:`CryptoCore.Hash.SHA256.new`).
...
.. csv-table:: 
    ...
    (such as :mod:`CryptoCore.Hash.SHAKE128`).
    ...
    construction (e.g. :mod:`CryptoCore.Hash.SHA256`).
    This is also a module attribute."
