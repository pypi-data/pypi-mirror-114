...
from CryptoCore.Cipher import PKCS1_OAEP, PKCS1_v1_5 as RSAES_PKCS1_v1_5
from CryptoCore.Signature import PKCS1_PSS, PKCS1_v1_5 as RSASSA_PKCS1_v1_5
from CryptoCore.Cipher import (AES, ARC2, ARC4, Blowfish, CAST, DES3, DES,
                           Salsa20, ChaCha20)
from CryptoCore.Hash import (HMAC, MD2, MD4, MD5, SHA224, SHA256, SHA384, SHA512,
                         CMAC, SHA3_224, SHA3_256, SHA3_384, SHA3_512,
                         BLAKE2b, BLAKE2s)
from CryptoCore.Random import get_random_bytes
import CryptoCore.Util.Counter
from CryptoCore.Util.number import bytes_to_long
try:
    from CryptoCore.Hash import SHA1
except ImportError:
    # Maybe it's called SHA
    from CryptoCore.Hash import SHA as SHA1
try:
    from CryptoCore.Hash import RIPEMD160
except ImportError:
    # Maybe it's called RIPEMD
    try:
        from CryptoCore.Hash import RIPEMD as RIPEMD160
    except ImportError:
        # Some builds of PyCryptoCore don't have the RIPEMD module
        RIPEMD160 = None
...
from CryptoCore.Random import random as pycrypto_random
...
class Benchmark:
    ...
    def generate_cipher(self, module, key_size, params):
        ...
        if le:
            ...
            ctr = CryptoCore.Util.Counter.new(module.block_size*8,
    ...
    def run(self):
        ...
        # CryptoCore.Random.random
        self.test_random_module("CryptoCore.Random.random", pycrypto_random)

        # CryptoCore.PublicKey
        for pubkey_name, module, key_bytes in pubkey_specs:
            self.test_pubkey_setup(pubkey_name, module, key_bytes)

        # CryptoCore.Cipher (block ciphers)
        ...
        # CryptoCore.Cipher (stream ciphers)
