...
from CryptoCore.Util.py3compat import bord, tobytes, _copy_bytes
...
_raw_poly1305 = load_pycryptocore_raw_lib("CryptoCore.Hash._poly1305",
                        """
...
def new(**kwargs):
    ...
    Args:
        ...
        cipher (module from ``CryptoCore.Cipher``):
            The cipher algorithm to use for deriving the Poly1305
            key pair *(r, s)*.
            It can only be ``CryptoCore.Cipher.AES`` or ``CryptoCore.Cipher.ChaCha20``.
