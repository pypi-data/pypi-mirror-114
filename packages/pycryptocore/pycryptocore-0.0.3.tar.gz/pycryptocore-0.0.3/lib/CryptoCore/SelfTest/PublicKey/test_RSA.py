...
"""Self-test suite for CryptoCore.PublicKey.RSA"""
...
import unittest
from CryptoCore.SelfTest.st_common import list_test_cases, a2b_hex, b2a_hex
...
class RSATest(unittest.TestCase):
    ...
    # TODO: PyCryptoCore treats the message as starting *after* the leading "00"
    ...
    def setUp(self):
        ...
        from CryptoCore.Util.number import bytes_to_long, inverse
    ...
    def test_construct_bad_key6(self):
        ...
        from CryptoCore.Util.number import inverse
