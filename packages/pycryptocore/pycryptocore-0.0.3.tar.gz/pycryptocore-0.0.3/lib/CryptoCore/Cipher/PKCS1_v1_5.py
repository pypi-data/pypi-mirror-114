...
from CryptoCore.Util.py3compat import bord, is_bytes, _copy_bytes

from CryptoCore.Util._raw_api import (load_pycryptocore_raw_lib, c_size_t,
                                  c_uint8_ptr)


_raw_pkcs1_decode = load_pycryptocore_raw_lib("CryptoCore.Cipher._pkcs1_decode",
                        """
...
class PKCS115_Cipher:
    ...
    Do not instantiate directly. Use :func:`CryptoCore.Cipher.PKCS1_v1_5.new` instead."""
...
def new(key, randfunc=None):
    ...
    :param key:
      The key to use to encrypt or decrypt the message. This is a `CryptoCore.PublicKey.RSA` object.
