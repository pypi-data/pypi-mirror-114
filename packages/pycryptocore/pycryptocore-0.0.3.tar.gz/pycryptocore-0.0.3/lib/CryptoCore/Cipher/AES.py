...
from CryptoCore.Cipher import _create_cipher
...
# Load portable AES
_raw_aes_lib = load_pycryptocore_raw_lib("CryptoCore.Cipher._raw_aes",
                                         _cproto)
...
try:
    ...
    if _cpu_features.have_aes_ni():
        _raw_aesni_lib = load_pycryptocore_raw_lib("CryptoCore.Cipher._raw_aesni",
                                                   _cproto.replace("AES",
                                                                   "AESNI"))
