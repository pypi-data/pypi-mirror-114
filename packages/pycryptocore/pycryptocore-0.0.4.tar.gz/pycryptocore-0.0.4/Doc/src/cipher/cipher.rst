:mod:`CryptoCore.Cipher` package
============================

Introduction
------------

The :mod:`CryptoCore.Cipher` package contains algorithms for protecting the confidentiality
of data.
...
*   You instantiate a cipher object by calling the :func:`new`
    function from the relevant cipher module (e.g. :func:`CryptoCore.Cipher.AES.new`).
...
This is a basic example::
    ...
    >>> from CryptoCore.Cipher import Salsa20
    >>>
