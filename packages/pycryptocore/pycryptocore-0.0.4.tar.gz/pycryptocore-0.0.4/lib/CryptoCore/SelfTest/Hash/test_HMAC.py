...
"""Self-test suite for CryptoCore.Hash.HMAC"""

import unittest
from binascii import hexlify
from CryptoCore.Util.py3compat import tostr, tobytes

from CryptoCore.Hash import (HMAC, MD5, SHA1, SHA256,
...
test_data = [
   ...
   # Test case 10 (SHA512)
    ...
    # From https://csrc.nist.gov/CSRC/media/Projects/CryptoCoregraphic-Standards-and-Guidelines/documents/examples/HMAC_SHA3-224.pdf
    (
    ...
    # From https://csrc.nist.gov/CSRC/media/Projects/CryptoCoregraphic-Standards-and-Guidelines/documents/examples/HMAC_SHA3-256.pdf
    (
        '000102030405060708090a0b0c0d0e0f'\
        '101112131415161718191a1b1c1d1e1f',
        xl('Sample message for keylen<blocklen'),
    ...
    # From https://csrc.nist.gov/CSRC/media/Projects/CryptoCoregraphic-Standards-and-Guidelines/documents/examples/HMAC_SHA3-384.pdf
    (
        '000102030405060708090a0b0c0d0e0f'\
        '101112131415161718191a1b1c1d1e1f'
        '202122232425262728292a2b2c2d2e2f',
    ...
    # From https://csrc.nist.gov/CSRC/media/Projects/CryptoCoregraphic-Standards-and-Guidelines/documents/examples/HMAC_SHA3-512.pdf
    (
        '000102030405060708090a0b0c0d0e0f'\
        '101112131415161718191a1b1c1d1e1f'\
        '202122232425262728292a2b2c2d2e2f'\
