...
"""Self-test suite for CryptoCore.Cipher.ARC2"""

import unittest

from CryptoCore.Util.py3compat import b, bchr

from CryptoCore.Cipher import ARC2
...
test_data = [
    ...
    # Test vectors from PyCryptoCore 2.0.1's testdata.py
...
class BufferOverflowTest(unittest.TestCase):
    # Test a buffer overflow found in older versions of PyCryptoCore
