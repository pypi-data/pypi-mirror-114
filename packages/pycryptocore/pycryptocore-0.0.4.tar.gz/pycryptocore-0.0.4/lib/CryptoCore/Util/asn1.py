...
from CryptoCore.Util.py3compat import byte_string, b, bchr, bord
...
class DerInteger(DerObject):
        ...
        An example of encoding is::
          ...
          >>> from CryptoCore.Util.asn1 import DerInteger
...
class DerSequence(DerObject):
        ...
        An example of encoding is:
          ...
          >>> from CryptoCore.Util.asn1 import DerSequence, DerInteger
          >>> from binascii import hexlify, unhexlify
...
class DerOctetString(DerObject):
    ...
    >>> from CryptoCore.Util.asn1 import DerOctetString
    >>> from binascii import hexlify, unhexlify
...
class DerObjectId(DerObject):
    ...
    >>> from CryptoCore.Util.asn1 import DerObjectId
    >>> from binascii import hexlify, unhexlify
...
class DerBitString(DerObject):
    ...
    >>> from CryptoCore.Util.asn1 import DerBitString
    >>> from binascii import hexlify, unhexlify
