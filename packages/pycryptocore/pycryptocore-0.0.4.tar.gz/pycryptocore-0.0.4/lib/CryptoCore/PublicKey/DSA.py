...
from CryptoCore.Util.py3compat import bchr, bord, tobytes, tostr, iter_range

from CryptoCore import Random
from CryptoCore.IO import PKCS8, PEM
from CryptoCore.Hash import SHA256
from CryptoCore.Util.asn1 import (
...
from CryptoCore.Math.Primality import (test_probable_prime, COMPOSITE,
                                   PROBABLY_PRIME)
...
class DsaKey(object):
        ...
        Args:
          ...
          protection (string):
            *Only in combination with a pass phrase*.
            ...
            the private DSA key.
            For a complete list of algorithms, see :mod:`CryptoCore.IO.PKCS8`.
          ...
          randfunc (callable):
            ...
            By default it is :func:`CryptoCore.Random.get_random_bytes`.
    ...
    def sign(self, M, K):
        raise NotImplementedError("Use module CryptoCore.Signature.DSS instead")
...
def generate(bits, randfunc=None, domain=None):
    ...
    Args:
      ...
      randfunc (callable):
        ...
        If not specified, :func:`CryptoCore.Random.get_random_bytes` is used.
