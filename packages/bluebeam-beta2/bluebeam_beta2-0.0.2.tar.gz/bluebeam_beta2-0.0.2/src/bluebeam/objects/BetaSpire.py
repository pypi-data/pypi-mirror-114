import math
from objects import Enemy, Laser, HomingRocket
import pygame
    ...
    def LaserBarrage(self):
        if self._attackburst > 17:
            las = self.l.create("Laser",
                                vec2(self.body.pos.x + (128 + 128 * (24 - self._attackburst)) * self.playerdir,
                                     self.body.pos.y - 512))
            las.width = 48
            las.dir = 1
            las.warmup = 0.67
            ...
            las = self.l.create("Laser",
                                vec2(self.body.pos.x + (64 + 128*7 - 128 * (17 - self._attackburst)) * self.playerdir,
                                     self.body.pos.y - 512))
            las.width = 48
            las.dir = 1
            las.warmup = 0.67
            ...
            las = self.l.create("Laser",
                                vec2(self.body.pos.x + (128 + 128 * (10 - self._attackburst)) * self.playerdir,
                                     self.body.pos.y - 512))
            las.width = 48
            las.dir = 1
            las.warmup = 0.6
            ...
            las = self.l.create("Laser",
                                vec2(self.body.pos.x + (128 + 768 * alt) * self.playerdir,
                                     self.body.pos.y - 512))
            las.width = 96
            las.dir = 1
            las.warmup = 1.0
