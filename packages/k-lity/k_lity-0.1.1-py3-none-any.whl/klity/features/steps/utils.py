...
def get_first_visible_element(context, elements):
    for element in elements:
        ...
        context.klity.trace(f" invisible: {element.get_attribute('class').lower()}")
        if (
...
def find(context, name, finders, visible, value, field=None):
    elements = []
...
def find_element(context, value, visible=True):
    ...
    finders = [
        Finder(
            "//*[not(self::p) and not(self::div) and not(self::li)"
            f" and normalize-space()={normalize_for_xpath(value)}]",
            lambda v: context.browser.find_elements_by_xpath(
                "//*[not(self::p) and not(self::div) and not(self::li)"
                f" and normalize-space()={normalize_for_xpath(v)}]",
            ),
        ),
        Finder(
        ...
        Finder(
            f"//*[normalize-space()={normalize_for_css(value)}]",
            lambda v: context.browser.find_elements_by_xpath(
                f"//*[normalize-space()={normalize_for_css(v)}]",
            ),
        ),
    ]
...
def find_input(context, value, visible=True):
    ...
    finders = [
        ...
        Finder(
            f"//*[self::input and normalize-space(.)={normalize_for_xpath(value)}]",
            lambda v: context.browser.find_elements_by_xpath(
                f"//*[self::input and normalize-space(.)={normalize_for_xpath(v)}]"
            ),
        ),
        Finder(
            f"//*[self::input and contains(.,{normalize_for_xpath(value)})]",
            lambda v: context.browser.find_elements_by_xpath(
                f"//*[self::input and contains(.,{normalize_for_xpath(v)})]"
            ),
        ),
        Finder(
            "//*[self::input and "
            ...
            lambda v: context.browser.find_elements_by_xpath(
                f"//*[self::input and normalize-space(@value)={normalize_for_xpath(v)}]"
            ),
        ),
        Finder(
            "//*[self::input and "
            ...
            lambda v: context.browser.find_elements_by_xpath(
                f"//*[self::input and normalize-space(@title)={normalize_for_xpath(v)}]"
            ),
        ),
        Finder(
            "//*[self::input and "
            ...
            lambda v: context.browser.find_elements_by_xpath(
                f"//*[self::input and normalize-space(@placeholder)={normalize_for_xpath(v)}]"
            ),
        ),
    ]
...
def find_checkbox(context, value, visible=True):
    ...
    finders = [
        Finder(
            f"input[type='checkbox'][value={normalize_for_xpath(value)}]",
            lambda v: context.browser.find_elements_by_css_selector(
                f"input[type='checkbox'][value={normalize_for_xpath(v)}]"
            ),
        ),
        Finder(
            f"input[type='checkbox'][id={normalize_for_xpath(value)}]",
            lambda v: context.browser.find_elements_by_css_selector(
                f"input[type='checkbox'][id={normalize_for_xpath(v)}]"
            ),
        ),
        Finder(
            f"input[type='checkbox'][name={normalize_for_xpath(value)}]",
            lambda v: context.browser.find_elements_by_css_selector(
                f"input[type='checkbox'][name={normalize_for_xpath(v)}]"
            ),
        ),
        Finder(
            f"input[type='checkbox'][title={normalize_for_xpath(value)}]",
            lambda v: context.browser.find_elements_by_css_selector(
                f"input[type='checkbox'][title={normalize_for_xpath(v)}]"
            ),
        ),
    ]
    # Trying to find input based on its label without blocking other tests
...
# TODO: Thoses two functions are not used for now...
