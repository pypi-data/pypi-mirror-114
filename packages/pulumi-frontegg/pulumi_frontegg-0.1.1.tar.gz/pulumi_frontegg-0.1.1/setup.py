...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'frontegg', '0.1.1', '--server', 'https://github.com/benesch/pulumi-frontegg/releases/download/v0.1.1/'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource frontegg 0.1.1`
                """)
            else:
                raise
