...
class RCBAnnotations(RCallback):
    ...
    def cbFiducials(self) -> bool:
        ...
        self.pjs.annotation_mode = PyJAMAS.fiducials
    ...
    def cbRectangles(self) -> bool:
        ...
        self.pjs.annotation_mode = PyJAMAS.rectangles
        self.pjs._poly_ = []
        QtWidgets.QApplication.setOverrideCursor(QtCore.Qt.CrossCursor)
    ...
    def cbPolylines(self) -> bool:
        ...
        self.pjs.annotation_mode = PyJAMAS.polylines
        self.pjs._poly_ = []
        QtWidgets.QApplication.setOverrideCursor(QtCore.Qt.CrossCursor)
    ...
    def cbLiveWire(self) -> bool:
        ...
        self.pjs.annotation_mode = PyJAMAS.livewire
        QtWidgets.QApplication.setOverrideCursor(QtCore.Qt.CrossCursor)
