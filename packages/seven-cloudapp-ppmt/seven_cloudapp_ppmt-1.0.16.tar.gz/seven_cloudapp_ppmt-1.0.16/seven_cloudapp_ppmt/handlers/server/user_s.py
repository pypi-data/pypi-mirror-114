...
:LastEditTime: 2021-04-15 15:26:08
...
class UserListHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        page_list, total = UserInfoModel(context=self).get_dict_page_list("id,act_id,open_id,user_nick,pay_price,user_state,surplus_integral", page_index, page_size, condition, order_by="id desc", params=params)
