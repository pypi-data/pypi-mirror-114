...
def stop(note="Manually stoped for debugging...", cmd=0):
	pout(note, show_time=True, time_format="datetime")
	sys.exit(cmd)
...
def out(
	...
	return rich_print.rich_print(*message, 
								to_console=to_console,
								to_file=to_file,to_file_mode=to_file_mode,
								show_time=show_time,time_format=time_format,time_symlink = time_symlink,
								identifier = identifier,
								msg_symlink=msg_symlink,
