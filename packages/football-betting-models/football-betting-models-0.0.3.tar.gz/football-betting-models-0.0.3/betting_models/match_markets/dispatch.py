...
def main(dec_odds, num_seeds, tol, format_num, vis_status):
    ...
    if format_num == 0:
        ...
        raise ValueError('Format number not recognised.')
    
    implied_hda = dec_2_implied(dec_odds)
    seeds_df, fig = model(num_seeds, tol).gen_seeds(implied_hda, vis_status)
    return seeds_df, fig
...
if __name__ == '__main__':
    ...
    seeds_df, fig = main(hda, num_seeds, tol, format_num, vis_status)
    print(seeds_df)
