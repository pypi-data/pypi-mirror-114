...
class ProcessData:
    ...
    def __init__(self, ID_object: int, ID_polygon: int, title: str, type: None, icon: str, mode: int,
...
class ReaderData:
    ...
    def __init__(self, ID_object_reader: int, ID_object: int, created_at: datetime,
...
class Object:
    ...
    def __init__(self, ID_object: int, ID_polygon: int, position: int, title: str, type: str, icon: str, mode: int,
                 created_at: datetime, updated_at: datetime, Reader: Optional[List[ReaderData]] = None,
