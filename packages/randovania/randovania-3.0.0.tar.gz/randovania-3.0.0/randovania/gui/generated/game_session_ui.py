...
class Ui_GameSessionWindow(object):
    def setupUi(self, GameSessionWindow):
        ...
        self.players_box_scroll = QScrollArea(self.central_widget)
        self.players_box_scroll.setObjectName(u"players_box_scroll")
        sizePolicy1 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.players_box_scroll.sizePolicy().hasHeightForWidth())
        self.players_box_scroll.setSizePolicy(sizePolicy1)
        self.players_box_scroll.setMinimumSize(QSize(0, 150))
        self.players_box_scroll.setWidgetResizable(True)
        self.players_box = QWidget()
        self.players_box.setObjectName(u"players_box")
        self.players_box.setGeometry(QRect(0, 0, 679, 148))
        ...
        self.main_layout.addWidget(self.players_box_scroll)
        ...
        sizePolicy2.setHeightForWidth(self.observer_group.sizePolicy().hasHeightForWidth())
        self.observer_group.setSizePolicy(sizePolicy2)
        ...
        sizePolicy4.setHeightForWidth(self.tab_generate.sizePolicy().hasHeightForWidth())
        self.tab_generate.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.tab_history.sizePolicy().hasHeightForWidth())
        self.tab_history.setSizePolicy(sizePolicy4)
        ...
        sizePolicy.setHeightForWidth(self.connection_group.sizePolicy().hasHeightForWidth())
