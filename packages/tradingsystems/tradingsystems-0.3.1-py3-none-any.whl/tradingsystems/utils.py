        ...
        **kwargs : Various
        ...
        if kwargs['entry_type'] == '2ma':
            ...
            entry_label = (str(kwargs['ma1'])
                           ...
                           +str(kwargs['ma2'])
                           +'-day : '
                           +kwargs['df_dict']['df_entry_signal_labels'][
                               kwargs['entry_type']][0]
                           +ma_type_label
                           +kwargs['df_dict']['df_entry_signal_labels'][
                               kwargs['entry_type']][1])
        ...
        if kwargs['exit_type'] == 'sar':
            ...
            exit_label = (str(kwargs['exit_period'])
                          ...
                          +'% AF '
                          +kwargs['df_dict']['df_exit_signal_labels'][
                              kwargs['exit_type']])
        ...
        if kwargs['stop_type'] in ['initial_dollar', 'breakeven', 
            ...
            stop_label = ('$'
                          ...
                          +' '                          
                          +kwargs['df_dict']['df_stop_signal_labels'][
                               kwargs['stop_type']])           
...
class Dates():
    ...
    @staticmethod
    def _date_set(start_date, end_date, lookback):
        """
