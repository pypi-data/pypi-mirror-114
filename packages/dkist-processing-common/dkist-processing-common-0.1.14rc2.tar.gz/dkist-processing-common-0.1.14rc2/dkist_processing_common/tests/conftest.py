...
class CalibrationSequenceDataset(Spec122Dataset):
    def __init__(
        ...
        # TODO pol_theta and ret_theta should be floats - change them back once the fits-spec is fixed
...
class NonPolCalDataset(Spec122Dataset):
    def __init__(self):
        ...
        self.add_constant_key("PAC__005", "none")
        self.add_constant_key("PAC__006", "clear")
        self.add_constant_key("PAC__007", "none")
