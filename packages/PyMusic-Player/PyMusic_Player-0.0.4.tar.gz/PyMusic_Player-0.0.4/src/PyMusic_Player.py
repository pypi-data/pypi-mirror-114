...
def Music_Player_GUI(song_dir_path,icon = None):
    ...
    realnames,statusbar,pausebutton,length,volu,pause

    print("Welcome from the the PyMusic_Player community. https://github.com/Spidy20/PyMusic_Player")
    root = tk.ThemedTk()
    root.get_themes()
...
Music_Player_GUI('E:\songs\kushal choice')