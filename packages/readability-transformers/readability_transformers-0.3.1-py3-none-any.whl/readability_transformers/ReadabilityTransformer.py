...
def _extract_features_batches(remain_id: str, remain_data: pd.DataFrame, feature_extractors, text_column, batch_size) -> pd.DataFrame:
    ...
    def pre_apply_features(
        ...
        for remain_id, remain_data in zip(remaining_ids, remaining):
            ...
            if batch_size is not None:
                remain_data = _extract_features_batches(remain_id, remain_data, feature_extractors, text_column, batch_size)
            else:
        ...
        if normalize:
            ...
            for feature in feature_list:
                ...
                if fmax == fmin:
                    ...
                    # fmax = fmax + 0.01*scalar
                    # fmin = fmin - 0.01*scalar
