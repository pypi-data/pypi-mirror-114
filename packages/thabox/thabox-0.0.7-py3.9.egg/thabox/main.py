...
try:
    ...
    from thabox.client.utils import User, Preferences, GoBack, clear
    from thabox.client.rendering import render_menu_screen, message_demo
    import thabox.client.login as login
    import thabox.client.credits as credits
    import thabox.client.help as help_page
    from thabox.client.client import update_user
