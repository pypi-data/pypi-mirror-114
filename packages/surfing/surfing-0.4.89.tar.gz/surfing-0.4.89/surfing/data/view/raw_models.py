...
class EmFuturePriceDetail(Base):
    ...
    CHANGE = Column('change', DOUBLE(asdecimal=False)) # 涨跌
    PCTCHANGE = Column('pct_change', DOUBLE(asdecimal=False)) # 涨跌幅
    ...
    PRECLEAR = Column('pre_clear', DOUBLE(asdecimal=False)) # 前结算价
    PCTCHANGECLEAR = Column('pct_change_clear', DOUBLE(asdecimal=False)) # 涨跌幅(结算价)
    CHANGECLEAR = Column('change_clear', DOUBLE(asdecimal=False)) # 涨跌(结算价)
    HQOI = Column('uni_oi', DOUBLE(asdecimal=False)) # 持仓量
    CHANGEOI = Column('uni_change_oi', DOUBLE(asdecimal=False)) # 持仓量变化 
    AMPLITUDE = Column('amplitude', DOUBLE(asdecimal=False)) # 振幅
