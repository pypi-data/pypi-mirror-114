...
class Topdesk:
    ...
    def request(self, scheme, url, data=None, params=None, extra=None):
        ...
        headers = {
            "User-Agent": "topdesk Python wrapper: https://gitlab.com/wobcom/topdesk",
        ...
        if "file" in extra:
            do_not_encode = True
            data = self._treat_file(extra.pop("file"), params)

        res = fn(
            url,
            headers=headers,
            data=data if do_not_encode else json.dumps(data),
            params=params,
            verify=self.verify,
            **extra
        )
    ...
    # topdesk is very... particular about the file upload format
    def _treat_file(self, file, params):
        if params is None:
            params = {}
        s = base64.b64encode(file[1].encode("utf-8"))
        pref = "".join(PARAM.format(k, v) for k, v in params.items())
        return pref + TPL.format(file[0], s.decode("ascii"))
    ...
    def escalate_incident(self, id_or_number, reason_id=None):
        ...
        """
        params = {"id": reason_id}
        return self._treat_incident(
            "/incidents/id/{}/escalate", id_or_number, params=params
        )
    ...
    def deescalate_incident(self, id_or_number, reason_id=None):
        ...
        params = {"id": reason_id}
        return self._treat_incident(
            "/incidents/id/{}/deescalate", id_or_number, params=params
        )
    ...
    def archive_incident(self, id_or_number, reason_id=None):
        ...
        params = {"id": reason_id}
        return self._treat_incident(
            "/incidents/id/{}/archive", id_or_number, params=params
        )
    ...
    def unarchive_incident(self, id_or_number, unarchive_partials=True):
        ...
        return self._treat_incident(
            "/incidents/id/{}/unarchive", id_or_number, params=params
        )
    ...
    def action_by_incident(self, incident_id_or_number, action_id, inline_images=False):
        ...
        return self.get(
            "/incidents/{}/actions/{}".format(path, action_id), params=params
        )

    @logged_in
    def incident_actions_by_incident(
        self, id_or_number, start=0, page_size=10, inline_images=False
    ):
        """
        Get incident actions by incident ID or number. Takes the optional
        parameters `start`, `page_size`, and `inline_images`.
        """
        params = {"start": start, "page_size": page_size, "inlineimages": inline_images}
        return self._treat_incident(
            "/incidents/id/{}/actions", id_or_number, params=params
        )

    @logged_in
    def progress_trail_by_incident(
        self, id_or_number, start=0, page_size=10, inline_images=False
    ):
        """
        ...
        params = {"start": start, "page_size": page_size, "inlineimages": inline_images}
        return self._treat_incident(
            "/incidents/id/{}/progresstrail", id_or_number, params=params
        )
    ...
    def progress_trail_count_by_incident(self, id_or_number):
        ...
        """
        return self._treat_incident(
            "/incidents/id/{}/progresstrail/count", id_or_number
        )

    @logged_in
    def requests_by_incident(
        self, id_or_number, start=0, page_size=10, inline_images=False
    ):
        """
        ...
        params = {"start": start, "page_size": page_size, "inlineimages": inline_images}
        return self._treat_incident(
            "/incidents/id/{}/requests", id_or_number, params=params
        )
    ...
    def service_windows(self, top=1000, name="", archived=None):
        ...
        - archived: whether or not the service windows should be archived
                    (default None)
        """
        params = {"top": top, "name": name, "archived": archived}
    ...
    @logged_in
    def upload_incident_attachment(self, id_or_number, f, params=None):
        """
        Upload a file to an incident identified by ID or number.
        `f` is of the format `(filename, contents)`.
        """
        path = self._treat_id_or_num(id_or_number)
        extra = {"file": f}
        return self.post(
            "/incidents/{}/attachments".format(path), extra=extra, params=params
        )
    ...
    def search(self, query, index="incidents", start=0):
        ...
        """
        params = {"query": query, "index": index, "start": start}
    ...
    def services(self, object_id=None, asset_id=None, top=1000):
        ...
        """
        params = {"objectId": object_id, "assetId": asset_id, "top": top}
    ...
    def reschedule_reservation(self, id_, start_date, end_date):
        ...
        """
        data = {"plannedStartDate": start_date or "", "plannedEndDate": end_date or ""}
    ...
    def reservable_locations(self, fields=None, top=1000, branch_id=None):
        ...
        """
        params = {"fields": fields, "top": top, "branchId": branch_id}
    ...
    def assets(self, template_id, fields=None, include_archived=None):
        ...
        - include_archived: if true, archived assets will be included (default:
                            None)
        """
        params = {"field": fields, "includeArchived": include_archived}
        return self.get(
            "/assetmgmt/assets/templateId/{}".format(template_id), params=params
        )
    ...
    def blank_asset(self, template_id=None, template_name=None):
        ...
        params = {"templateId": template_id, "templateName": template_name}
    ...
    def grid_assets(self, asset_id, field_id):
        ...
        params = {"assetId": asset_id, "fieldId": field_id}
    ...
    def create_action_for_change(self, id_, memo_text, type_):
        ...
        url = "/managerAuthorizableChanges/{}/progresstrail"
        data = {"memoText": memo_text, "type": type_}
    ...
    def change_requests(self, id_, inline_images=False, browser_friendly_urls=False):
        ...
        return self.get(
            "/managerAuthorizableChanges/{}/requests".format(id_), params=params
        )
    ...
    def update_change_status(self, id_, from_, action, reason=None, comment=None):
        ...
        """
        data = {"from": from_, "action": action, "reason": reason, "comment": comment}
    ...
    def update_authorization_activity(self, id_, action, reason=None, comment=None):
        ...
        - comment: comment about transaction
        """
        data = {"action": action, "reason": reason, "comment": comment}
    ...
    def requester_changes(self, ids=None, requester_ids=None, open_=None):
        ...
        """
        params = {"id": ids, "requesterId": requester_ids, "open": open_}
    ...
    @logged_in
    def requester_change_progress_trail(
        self,
        id_,
    ):
    ...
    @logged_in
    def requester_change_requests(
        self, id_, inline_images=False, browser_friendly_urls=False
    ):
        """
        Get the list of requests for a change. Optional parameters:
        - inline_images: whether inline images should be returned
    ...
    def operator_change_activities(self, changes=None, archived=None):
        ...
        """
        params = {"change": changes, "archived": archived}
    ...
    @logged_in
    def operator_change_activity_requests(
        self, id_, inline_images=False, browser_friendly_urls=False
    ):
        """
        ...
        return self.get(
            "/operatorChangeActivities/{}/requests".format(id_), params=params
        )

    @logged_in
    def operator_change_activity_progress_trail(
        self, id_, inline_images=False, browser_friendly_urls=False
    ):
        """
    ...
    @logged_in
    def change_calendar_progress_trail(
        self, id_, inline_images=False, browser_friendly_urls=False
    ):
        """
        Get progress trail for an operator change activity identified by ID.
