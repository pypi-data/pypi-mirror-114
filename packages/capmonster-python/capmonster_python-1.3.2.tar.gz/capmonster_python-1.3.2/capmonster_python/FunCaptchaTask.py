...
class FunCaptchaTask(CapmonsterClient):
    ...
    def createTask(self, website_url, website_public_key, proxyAddress, proxyPort: int, proxyLogin, proxyPassword,
                   proxyType="https", js_subdomain=None, data_blob=None):
        data = {
