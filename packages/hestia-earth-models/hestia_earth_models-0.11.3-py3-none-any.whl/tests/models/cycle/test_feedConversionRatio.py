...
from hestia_earth.models.cycle.feedConversionRatio import run, _should_run

class_path = 'hestia_earth.models.cycle.feedConversionRatio'
fixtures_folder = f"{fixtures_path}/cycle/feedConversionRatio"
...
@patch(f"{class_path}._new_practice", side_effect=fake_new_practice)
def test_run_with_carcasse(*args):
