...
class AbsolutePosSizeBinder:
    ...
    def __init__(self, *widgets: Widget, bind_window_size: bool = False):
        ...
        self.relatives: List[Widget] = list()
        self.main_app = App.get_running_app().main_app

        self._pos_attributes: List[PropagatedAttributes] = list()
        self._size_attributes: List[PropagatedAttributes] = list()
        self._pos_callbacks: List[PosSizeCallable] = list()
        self._size_callbacks: List[PosSizeCallable] = list()
        self._bound_wid_properties: List[BoundWidgetPropertyId] = list()
        self._bound_rel_properties: List[BoundWidgetPropertyId] = list()
