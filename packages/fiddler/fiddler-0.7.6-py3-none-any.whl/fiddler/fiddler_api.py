...
class FiddlerApi:
    ...
    def register_model(
        ...
        for i in range(4):
            try:
                ...
                elif deployment.deployment_type == 'predictor':
                    self._deploy_mlflow_model(
    ...
    def upload_segment(
        ...
        try:
            _validate_segment(segment_id, segment_info, model_info)
...
def _validate_segment(segment_id, segment_info, model_info):
    ...
    segment_info.validate(model_info)
