...
class TaskCreateParams(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"body",b"body",u"owner_id",b"owner_id",u"priority",b"priority",u"status",b"status",u"timestamp",b"timestamp",u"title",b"title"]) -> None: ...
...
class ActionParams(google___protobuf___message___Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"params",b"params"]) -> typing_extensions___Literal["charge_refund_params","subscription_trial_update_params","coupon_apply_params","opportunity_create_params","task_create_params","custom_params"]: ...
