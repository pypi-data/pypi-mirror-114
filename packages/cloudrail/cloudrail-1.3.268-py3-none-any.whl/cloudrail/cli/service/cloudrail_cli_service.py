...
from common.api.dtos.user_dto import UserWithTokenDTO, UserDTO, ApiKeyDTO
...
class CloudrailCliService:
    ...
    def submit_filtered_plan(self, show_output: str, job_id: str, custom_rules: dict, drift_track: bool):
