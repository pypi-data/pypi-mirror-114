...
def main():
    ...
    parser.add_argument('-f', 
                        help=f"Format of the new filename. Default = \"{config.format}\".\n"+
                        "Valid tags:\n"+
                        "\n".join([key+val for key,val in AllowedTags.items()]),
                        action="store", dest="format", type=str, default=config.format)
    ...
    parser.add_argument('-max_length_authors', 
                        ...
                        action="store", dest="max_length_authors", type=int, default=config.max_length_authors)
    parser.add_argument('-max_length_filename', 
                        ...
                        action="store", dest="max_length_filename", type=int, default=config.max_length_filename)
    parser.add_argument('-numb_results_google_search', 
                        ...
                        action="store", dest="numb_results_google_search", type=int, default=config.numb_results_google_search)
    parser.add_argument(
    ...
    if args.set_default:
        set_default_values(format=args.format, 
