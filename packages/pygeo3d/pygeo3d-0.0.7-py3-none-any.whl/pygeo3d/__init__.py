...
def distance(
    obj1: Union[Point, Line, Plane], obj2: Union[Point, Line, Plane], /
    ):
...
def angle(obj1: Union[Line, Plane], obj2: Union[Line, Plane], /):
...
def parallel(*objects: Union[Line, Plane]):
...
def perpendicular(obj1: Union[Line, Plane], obj2: Union[Line, Plane], /):
...
def intersection(
    obj1: Union[Line, Plane], obj2: Union[Line, Plane], obj3: Plane=None, /
    ):
...
def image(obj1: Union[Point, Line, Plane], obj2: Union[Line, Plane], /):
...
def projection(obj1: Union[Point, Line], obj2: Union[Line, Plane], /):
